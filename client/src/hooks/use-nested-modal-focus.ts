...
export function useNestedModalFocus({
  ...
  const handleKeyDown = useCallback(
    ...
    [shouldTrapFocus, getFocusableElements, onClose, focusFirstElement, focusLastElement, nestingLevel]
  );
  ...
  useEffect(() => {
    ...
    return undefined;
  }, [isOpen, isInitialized, autoFocus, restoreFocus]);
...
export function useNestedModalStack() {
  ...
  const isActiveModal = useCallback((level: number) => {
