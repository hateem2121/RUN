...
export class MediaApiValidator {
	 ...
	 */
	static validateMediaList(
		data: unknown,
	): z.infer<typeof MediaListResponseSchema> {
		try {
	 ...
	 */
	static validateMediaSingle(
		data: unknown,
	): z.infer<typeof MediaSingleResponseSchema> | null {
		try {
	 ...
	 */
	static validateMediaUpload(
		data: unknown,
	): z.infer<typeof MediaUploadResponseSchema> {
		try {
	 ...
	 */
	static validateMediaBatch(
		data: unknown,
	): z.infer<typeof MediaBatchResponseSchema> {
		try {
	 ...
	 */
	static validateMediaDelete(
		data: unknown,
	): z.infer<typeof MediaDeleteResponseSchema> {
		try {
	 ...
	 */
	static validateMediaAsset(
		data: unknown,
	): z.infer<typeof MediaAssetSchema> | null {
	 ...
	 */
	static sanitizeMediaAssets(
		data: unknown[],
	): z.infer<typeof MediaAssetSchema>[] {
		if (!Array.isArray(data)) {
			logSchemaError(
				data,
				["Expected array for media assets"],
				"Asset Array Validation",
				"medium",
			);
			return [];
		}
