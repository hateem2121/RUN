 ...
 */
export function enhanceAssetUrl(asset: { id: string | number; url: string }, expectedWidth: number = 1200): string {
  ...
  const assetId = typeof asset.id === 'string' ? parseInt(asset.id) : asset.id;
