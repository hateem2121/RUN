...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  usePrefetchAdminData(); // Prefetch common admin data
  ...
  const links = [
    ...
    },
    {
      ...
      href: "/admin/products",
      icon: (
        <IconShirt className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Fibers",
    ...
    },
    {
      ...
      href: "/admin/fabrics",
      icon: (
        <IconFileFilled className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Certificates",
    ...
    },
    {
      ...
      icon: (
        <IconRuler className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Accessories",
...

    {
      ...
      icon: (
        <IconNavigation className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Footer",
    ...
    },
    {
      ...
      icon: (
        <IconInbox className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Homepage",
    ...
    },
    {
      ...
      icon: (
        <IconLeaf className="h-5 w-5 shrink-0 text-neutral-700 dark:text-neutral-200" />
      ),
    },
    {
      label: "Manufacturing",
  ...
  return (
    <div className="admin-layout-root bg-white dark:bg-neutral-900">
      ...
      <div className="ml-[60px] lg:ml-[300px] bg-white dark:bg-neutral-900 pt-16 md:pt-0">
        <div className="border border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-900 p-6">
          <AdminBreadcrumb />
          <div className="mt-4">
            {children}
          </div>
...
export const Logo = () => {
  return (
    <div className="relative z-10 flex items-center space-x-2 py-1 text-sm font-normal text-black">
