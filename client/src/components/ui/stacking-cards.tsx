		...
		>
			...
			>
				...
				<div className="relative z-10 flex flex-col h-full">
					...
					<div
						className={`flex flex-col md:flex-row flex-1 gap-6 md:gap-8 items-stretch`}
					>
						<div
							className={`w-full md:w-[40%] flex flex-col justify-center min-h-0`}
						>
...
export default function StackingCards({
	...
	const stackingCards: StackingCard[] = sortedSections.map((section) => ({
		...
		description:
			section.content ||
			"Professional manufacturing services tailored to your needs.",
		mediaId:
			...
			<section className="py-20">
				<div className="container mx-auto px-4 md:px-6 text-center">
					...
					<p className="text-muted-foreground">
						No manufacturing capabilities configured yet.
					</p>
				</div>
			</section>
		);
			...
			<div className="py-20">
				<div className="container mx-auto px-4 md:px-6 text-center">
					...
					>
						...
						>
							Discover our comprehensive B2B sportswear solutions through our
