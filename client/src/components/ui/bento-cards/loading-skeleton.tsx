...
const LoadingSkeleton = memo(function LoadingSkeleton({
  ...
  if (type === 'media') {
    return (
      <div className={cn(baseClasses, "w-full h-full rounded-xl")}>
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-16 h-16 border-4 border-luxury-gray-300 border-t-luxury-gold rounded-full animate-spin" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className={cn(baseClasses, "w-full h-full rounded-2xl p-6")}>
