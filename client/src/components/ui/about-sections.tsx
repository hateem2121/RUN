        ...
        {statistics.length > 0 && (
          ...
          >
            {statistics.map((stat, index) => {
              const IconComponent = stat.icon === 'Globe' ? Globe2 :
                stat.icon === 'Award' ? Award :
                  stat.icon === 'TrendingUp' ? TrendingUp :
                    stat.icon === 'Sparkles' ? Sparkles :
                      stat.icon === 'Factory' ? Factory :
                        stat.icon === 'Users' ? Users : Package;
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          {services.map((service, index) => {
            const IconComponent = service.icon === 'Factory' ? Factory :
              service.icon === 'Award' ? Award :
                service.icon === 'Globe2' ? Globe2 :
                  service.icon === 'Package' ? Package : Sparkles;
