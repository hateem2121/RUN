		...
		return (
			<Card className="w-full max-w-md mx-auto border-destructive/20 bg-destructive/5">
				<CardHeader className="text-center pb-4">
					<div
						className={`mx-auto w-12 h-12 rounded-full bg-destructive/10 flex items-center justify-center mb-3`}
					>
					...
					{showDevDetails && (
						<details className="text-xs">
							...
							<div className="mt-2 p-2 bg-muted/30 rounded border">
								...
								<div className="text-red-600 font-mono break-all mb-2">
									{error.message}
								</div>

								<div className="font-medium">Error ID:</div>
								<div className="text-muted-foreground font-mono break-all mb-2">
									{this.state.errorId}
								</div>
