		...
		return {
			...
			leftContent: !isEven
				? {
						...
						description:
							section.content ||
							`Professional ${section.sectionType || "manufacturing"} services`,
					}
				: null,
			rightContent: isEven
				? {
						...
						description:
							section.content ||
							`Advanced ${section.sectionType || "manufacturing"} capabilities`,
					}
				: null,
		};
	});
	...
	if (title && pages.length > 0) {
		pages.unshift({
			...
			rightContent: {
				...
				description:
					description ||
					"Comprehensive B2B sportswear solutions from design to delivery",
			},
		});
	}
			...
			<section className="py-20 bg-muted/20">
				<div className="container mx-auto px-4 md:px-6 text-center">
					...
					<p className="text-muted-foreground">
						{description || "No sections configured yet."}
					</p>
				</div>
			</section>
		);
