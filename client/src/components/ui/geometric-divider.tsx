...
export function GeometricDivider({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative flex items-center justify-center py-16 px-4",
        className
      )}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div
            ...
            style={{
              ...
              background: "linear-gradient(to right, transparent, rgba(26, 26, 26, 0.2), rgba(26, 26, 26, 0.4), rgba(26, 26, 26, 0.2), transparent)"
            }}
          />
        </div>
      </div>
