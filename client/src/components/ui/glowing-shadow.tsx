...
export function GlowingShadow({ children }: GlowingShadowProps) {
	return (
        ...
        .glow:after {
          ...
          display: block;
          z-index: -2;
          filter: blur(calc(var(--glow-blur-sm) * 10px));
          width: 130%;
          height: 130%;
          left: -15%;
          top: -15%;
        ...
        .glow-container:hover .glow-content {
          ...
          animation: shadow-sm-pulse calc(var(--animation-speed) * 2) linear infinite;
        }
        ...
        .glow-container:hover .glow:after {
          --glow-translate-y: 0;
          animation-play-state: paused;
          transition: --glow-translate-y 0s ease, --glow-blur-sm 0.05s ease,
                      --glow-opacity 0.05s ease, --glow-scale 0.05s ease,
                      --glow-radius 0.05s ease;
        }

        @keyframes shadow-sm-pulse {
          0%, 24%, 46%, 73%, 96% {
            --white-shadow: 0.5;
          }
