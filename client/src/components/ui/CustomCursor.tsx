...
const CustomCursor: React.FC = () => {
  ...
  return (
    <>
      <div
        ref={cursorRef}
        className="hidden md:block fixed top-0 left-0 w-2 h-2 bg-white rounded-full pointer-events-none z-max mix-blend-difference"
      />
      <div
        ref={followerRef}
        className="hidden md:block fixed top-0 left-0 w-4 h-4 border border-white rounded-full pointer-events-none z-[9999] overflow-hidden flex items-center justify-center bg-white mix-blend-difference"
      >
