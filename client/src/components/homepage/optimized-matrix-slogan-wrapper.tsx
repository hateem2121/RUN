...
export const OptimizedMatrixSloganWrapper = memo(function OptimizedMatrixSloganWrapper({
  ...
  const optimizedDisplayDuration = isMobile ? (displayDuration || 3000) * 0.8 : (displayDuration || 3000);

  return (
    <div
      ref={ref}
      className={`matrix-text-optimized animation-container ${isIntersecting ? 'animation-active' : 'animation-paused'
