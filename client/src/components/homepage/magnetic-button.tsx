...
export const MagneticButton = memo(function MagneticButton({
  ...
  return (
    <motion.button
      ...
      onClick={handleClick}
      className={`relative transform overflow-hidden rounded-xl px-6 py-3 font-medium transition-all duration-500 ${baseClasses} ${className}`}
    ...
    >
      ...
      {/* Button content */}
      <span className="relative z-10 drop-shadow-[0_2px_8px_rgba(0,0,0,0.3)]">{children}</span>
