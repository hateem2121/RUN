...
export function MechanicalGears() {
	...
	return (
		<div className="fixed inset-0 pointer-events-none overflow-hidden opacity-10">
			<svg
				ref={gear1Ref}
				className="absolute top-20 right-20 w-32 h-32 text-blue-600"
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
				strokeWidth="2"
			...
			<svg
				ref={gear2Ref}
				className="absolute bottom-40 left-32 w-48 h-48 text-blue-500"
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
				strokeWidth="2"
			...
			<svg
				ref={gear3Ref}
				className="absolute top-1/2 left-1/2 w-24 h-24 text-blue-400"
				viewBox="0 0 24 24"
				fill="none"
				stroke="currentColor"
				strokeWidth="2"
