  ...
  return (
    <>
      ...
      <FocusScope trapped restoreFocus>
        <div className="fixed inset-y-0 right-0 z-modal flex h-full w-full transform flex-col border-slate-200 border-l bg-white shadow-2xl transition-transform duration-300 ease-in-out md:w-[480px]">
          {/* Header */}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full resize-none rounded-md border border-slate-300 px-3 py-2 outline-none focus:ring-2 focus:ring-ring"
