            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {checkpoints.length > 0 && (
                  <div className="mt-2">
                    <p className="text-xs font-medium text-gray-500">Checkpoints:</p>
      ...
      <CardContent>
        ...
        <EnhancedDialog open={showQualityDialog} onOpenChange={setShowQualityDialog}>
          ...
          >
            ...
            <form onSubmit={handleQualitySubmit} className="flex flex-col min-h-0 flex-1">
                  ...
                  <div className={showPreview ? "flex-1 space-y-4" : "space-y-4"}>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setQualityForm({ ...qualityForm, title: e.target.value })
                          }
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setQualityForm({ ...qualityForm, category: e.target.value })
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setQualityForm({ ...qualityForm, frequency: e.target.value })
                          }
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setQualityForm({ ...qualityForm, description: e.target.value })
                        }
