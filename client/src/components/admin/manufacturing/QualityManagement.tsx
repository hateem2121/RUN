...
export function QualityManagement({ mediaAssets }: QualityManagementProps) {
	const [editingQuality, setEditingQuality] =
		useState<ManufacturingQuality | null>(null);
	...
	const { data: qualityStandards = [], isLoading: qualityLoading } =
	...
	const finalSelectedQualityImage =
		selectedQualityImage || specificQualityImage;
	...
	const handleRemoveCheckpoint = (index: number) => {
		const newCheckpoints = qualityForm.checkpoints.filter(
			(_, i) => i !== index,
		);
			...
			<CardHeader>
				<div className="flex items-center justify-between">
					<div>
						...
						<CardDescription>
							Manage quality assurance standards, checkpoints, and compliance
							requirements
						</CardDescription>
					</div>
					<Button
			...
			<CardContent>
				{qualityLoading ? (
					...
					<div className="text-center py-8 text-gray-500">
						No quality standards found. Create your first quality standard to
						get started.
					</div>
				) : (
					<DndContext
										...
										<div className="grid grid-cols-2 gap-4">
											...
											<div>
												...
												<Select
													...
													onValueChange={(value) =>
														setQualityForm({ ...qualityForm, icon: value })
													}
												>
													<SelectTrigger>
														<SelectValue />
											...
											<div className="flex items-center gap-2 mt-1">
												...
												{finalSelectedQualityImage && (
													<Button
														...
														variant="ghost"
														onClick={() =>
															setQualityForm({ ...qualityForm, imageId: null })
														}
													>
														Clear
													</Button>
										...
										<div className="flex-1 border-l pl-6">
											<div className="sticky top-0 space-y-4">
												...
												<div className="p-4 bg-muted/50 rounded-lg text-xs text-muted-foreground">
													<p>
														This preview shows how the quality standard card
														will appear on the public site. The layout size may
							...
							<EnhancedDialogFooter>
								...
								<Button
									...
									disabled={
										...
										updateQualityMutation.isPending
									}
								>
									{editingQuality
