      ...
      <CardContent>
        ...
        <EnhancedDialog open={showCapabilityDialog} onOpenChange={setShowCapabilityDialog}>
          ...
          >
            ...
            <form onSubmit={handleCapabilitySubmit} className="flex flex-col min-h-0 flex-1">
                  ...
                  <div className={showPreview ? "flex-1 space-y-4" : "space-y-4"}>
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={(value) =>
                            setCapabilityForm({ ...capabilityForm, icon: value })
                          }
                        >
                          <SelectTrigger>
                            <SelectValue />
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setCapabilityForm({ ...capabilityForm, capacity: e.target.value })
                          }
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            setCapabilityForm({ ...capabilityForm, category: e.target.value })
                          }
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          setCapabilityForm({ ...capabilityForm, description: e.target.value })
                        }
                    ...
                    <div className="flex items-center space-x-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) =>
                          setCapabilityForm({ ...capabilityForm, isActive: checked })
                        }
                      />
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <Input
                          ...
                          onChange={(e) =>
                            setNewSpecForm({ ...newSpecForm, label: e.target.value })
                          }
                        />
                        <Input
                          placeholder="Value"
                          ...
                          onChange={(e) =>
                            setNewSpecForm({ ...newSpecForm, value: e.target.value })
                          }
                        />
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {finalSelectedCapabilityImage && (
                          <Button
                            type="button"
                            variant="ghost"
                            onClick={() => setCapabilityForm({ ...capabilityForm, imageId: null })}
                          >
                            Clear
                          </Button>
                        )}
