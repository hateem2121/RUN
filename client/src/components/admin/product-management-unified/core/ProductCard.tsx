...
export const ProductCard = memo(function ProductCard({
	...
	const primaryVideo = product.primaryVideoId
		? getMediaAsset(product.primaryVideoId)
		: null;
	...
	return (
		<>
			<Card
				className={`transition-all duration-200 hover:shadow-lg cursor-pointer relative overflow-hidden ${
					isHovered ? "border-blue-300 shadow-xl scale-[1.02]" : ""
				}`}
				onMouseEnter={() => setIsHovered(true)}
				onMouseLeave={() => setIsHovered(false)}
				onClick={onSelect}
