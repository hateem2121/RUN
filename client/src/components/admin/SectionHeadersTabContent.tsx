          ...
          <div className="space-y-4 border-b pb-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onLocalUpdate({ metricsTitle: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onLocalUpdate({ metricsDescription: e.target.value })
                }
                rows={2}
              />
            </div>
          ...
          <div className="space-y-4 border-b pb-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onLocalUpdate({ initiativesTitle: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onLocalUpdate({ initiativesDescription: e.target.value })
                }
                rows={2}
              />
            </div>
          ...
          <div className="space-y-4 border-b pb-6">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onLocalUpdate({ certificationsTitle: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onLocalUpdate({ certificationsDescription: e.target.value })
                }
                rows={2}
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onLocalUpdate({ certificationsFooterNote: e.target.value })
                }
                rows={2}
              />
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  onLocalUpdate({ goalsTitle: e.target.value })
                }
              />
            </div>
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  onLocalUpdate({ goalsDescription: e.target.value })
                }
                rows={2}
              />
            </div>
