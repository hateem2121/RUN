            ...
            <div className="space-y-3">
              ...
              <div className="custom-scrollbar flex max-h-28 flex-wrap gap-3 overflow-y-auto">
                {selectedAssetsForDisplay.map((asset: MediaAsset) => (
                  <div
                    key={asset.id}
                    className={`group relative flex min-w-0 max-w-56 items-center gap-3 rounded-xl border-2 px-4 py-2.5 transition-all duration-200 hover:scale-[1.02] hover:shadow-md ${getAssetTypeColor(asset.type)}
                  `}
