...
export function AboutHeroTab() {
  ...
  const { data: mediaResponse } = useQuery<{ success: boolean; data: MediaAsset }>({
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-4">
                      {selectedMedia ? (
                        ...
                        <div className="w-32 h-20 bg-muted rounded-md flex items-center justify-center border border-dashed">
        ...
        <div className="space-y-6">
          <Card className="h-full flex flex-col">
            ...
            <CardContent className="flex-1 p-0 overflow-hidden bg-background border rounded-b-lg relative min-h-[400px]">
              <div className="absolute inset-0 overflow-y-auto">
                <div className="transform scale-[0.8] origin-top md:origin-top-left w-[125%] md:w-[125%]">
                  <HeroSection
                    heroData={{
      ...
      <StandardMediaSelectionDialog
        ...
        onSelect={(asset: MediaAsset | MediaAsset[]) => {
          ...
          if (selected) {
            form.setValue("backgroundMediaId", selected.id, { shouldDirty: true });
