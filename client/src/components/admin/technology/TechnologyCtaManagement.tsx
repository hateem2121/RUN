	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Configure the main CTA section that replaces the Technology Solution
					area
				</CardDescription>
			</CardHeader>
			<CardContent>
					...
					<form onSubmit={handleCtaSubmit} className="space-y-6">
						...
						<div>
							...
							<Input
								...
								onChange={(e) =>
									setCtaForm((prev) => ({ ...prev, headline: e.target.value }))
								}
						...
						<div>
							...
							<Textarea
								...
								onChange={(e) =>
									setCtaForm((prev) => ({ ...prev, content: e.target.value }))
								}
