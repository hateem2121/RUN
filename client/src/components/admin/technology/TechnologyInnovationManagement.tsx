      ...
      <div className="flex items-start justify-between">
        <div className="flex items-start gap-4 flex-1">
          ...
          <div className="flex-1">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full bg-purple-100 text-purple-700 inline-block mt-1">
              {innovation.category}
            </span>
            {innovation.description && (
              <p className="text-sm text-gray-600 mt-2">{innovation.description}</p>
            )}
...
export function TechnologyInnovationManagement({
  ...
  const updateInnovationMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: Partial<InnovationFormData> }) =>
      apiRequest(`/api/technology-innovations/${id}`, { method: "PATCH", body: data }),
    onSuccess: () => {
      getQueryClient().invalidateQueries({ queryKey: ["/api/technology-innovations"] });
      setShowInnovationDialog(false);
      setEditingInnovation(null);
  ...
  const reorderInnovationsMutation = useMutation({
    mutationFn: (innovations: { id: number; position: number }[]) =>
      apiRequest("/api/technology-innovations/reorder", { method: "PATCH", body: { innovations } }),
    onSuccess: () => {
      getQueryClient().invalidateQueries({ queryKey: ["/api/technology-innovations"] });
    },
  });
            ...
            <EnhancedDialogBody className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setInnovationForm({ ...innovationForm, name: e.target.value })}
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setInnovationForm({ ...innovationForm, developmentYear: e.target.value })
                  }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setInnovationForm({ ...innovationForm, shortDescription: e.target.value })
                  }
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setInnovationForm({ ...innovationForm, iconName: e.target.value })
                    }
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setInnovationForm({ ...innovationForm, description: e.target.value })
                  }
                  ...
                  {innovationForm.imageId && (
                    <div className="mt-2 text-sm text-gray-600">
                      ...
                      <Button
                        ...
                        onClick={() => setInnovationForm({ ...innovationForm, imageId: null })}
                      >
                        Remove
                      </Button>
                    </div>
