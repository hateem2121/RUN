...
export class AdminErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    // Log error details
    console.error(`[AdminErrorBoundary:${this.props.module}] Error caught:`, error);
  ...
  private reportError = (error: Error, errorInfo: ErrorInfo) => {
    ...
    fetch('/api/admin/error-report', {
      ...
      console.warn('[AdminErrorBoundary] Failed to report error:', reportError);
    });
  };
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  ...
                  <CardDescription className="flex items-center gap-2 mt-1">
                    <Badge variant={this.getSeverityColor(severity) as "destructive" | "secondary" | "outline"}>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <p className="text-sm text-blue-700">
                  ...
                  This could be due to a network issue, data problem, or temporary service interruption.
              ...
              {process.env.NODE_ENV === 'development' && (
                <details className="text-xs">
                  ...
                  <div className="mt-2 bg-gray-900 text-gray-100 p-3 rounded overflow-auto max-h-40">
