...
interface FormData {
  ...
  featuredContent: {
    ...
    card4: { title: string; description: string; mediaUrl: string; link: string };
  };
}
...
export default function CategoryForm({
  ...
  const updateFeaturedCard = (cardIndex: number, updates: Partial<FormData['featuredContent']['card1']>) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('🚀 [FORM] handleSubmit called with data:', formData);
    
    // Basic validation
    if (!formData.name.trim() || !formData.slug.trim()) {
      console.log('❌ [FORM] Validation failed: missing name or slug');
      return;
    }
    ...
    const submitData = {
      ...
      featuredContent: {
        card1: {
          ...
          mediaUrl: formData.featuredContent.card1.mediaUrl && formData.featuredContent.card1.mediaUrl !== 'undefined' ? formData.featuredContent.card1.mediaUrl.trim() : "",
          link: (formData.featuredContent.card1.link || "").trim(),
          // Enhanced Card 1 dual media fields
          maskSvgUrl: formData.featuredContent.card1.maskSvgUrl && formData.featuredContent.card1.maskSvgUrl !== 'undefined' ? formData.featuredContent.card1.maskSvgUrl.trim() : "",
          contentMediaUrl: formData.featuredContent.card1.contentMediaUrl && formData.featuredContent.card1.contentMediaUrl !== 'undefined' ? formData.featuredContent.card1.contentMediaUrl.trim() : "",
        },
        card2: {
          title: (formData.featuredContent.card2.title || "").trim(),
          description: (formData.featuredContent.card2.description || "").trim(),
          mediaUrl: formData.featuredContent.card2.mediaUrl && formData.featuredContent.card2.mediaUrl !== 'undefined' ? formData.featuredContent.card2.mediaUrl.trim() : "",
        ...
        card3: {
          ...
          mediaUrl: formData.featuredContent.card3.mediaUrl && formData.featuredContent.card3.mediaUrl !== 'undefined' ? formData.featuredContent.card3.mediaUrl.trim() : "",
        ...
        card4: {
          ...
          mediaUrl: formData.featuredContent.card4.mediaUrl && formData.featuredContent.card4.mediaUrl !== 'undefined' ? formData.featuredContent.card4.mediaUrl.trim() : "",
  ...
  const handleMediaSelect = (mediaUrl: string) => {
    if (mediaUrl && mediaPickerTarget) {
      ...
      if (mediaPickerTarget === 'card1-svg') {
        ...
        const cardIndex = parseInt(mediaPickerTarget.replace('card', '')) - 1;
  ...
  return (
    <>
      <EnhancedDialog open={open} onOpenChange={onClose}>
        <EnhancedDialogContent className="z-modal pointer-events-auto" contentType="form">
                        ...
                        <div key={index} className="p-4 border rounded-lg">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <div>
                              ...
                              <Input
                                value={card.title}
                                onChange={(e) => updateFeaturedCard(index, { title: e.target.value })}
                            ...
                            <div>
                              ...
                              <Input
                                value={card.link}
                                onChange={(e) => updateFeaturedCard(index, { link: e.target.value })}
                          ...
                          <div className="mt-4">
                            ...
                            <Textarea
                              ...
                              onChange={(e) => updateFeaturedCard(index, { description: e.target.value })}
                          ...
                          {index === 0 ? (
                            <div className="mt-4">
                              <div className="p-3 bg-blue-50 border-2 border-blue-200 rounded-lg">
                                <Label className="text-sm font-semibold text-blue-700">🎭 Custom SVG Masking Media</Label>
                                <p className="text-xs text-gray-600 mb-3">Select an SVG file for the mask shape and a video/image for the content</p>
                                
                                {/* SVG Mask Selection */}
                                <div className="space-y-2 mb-4">
                                  <Label className="text-sm font-medium">SVG Mask File *</Label>
                                ...
                                <div className="space-y-2">
                                  <Label className="text-sm font-medium">Content Media File *</Label>
                                  <div className="flex items-center gap-2">
                                    <Button
                                      type="button"
                                      variant="outline"
                                ...
                                {/* Clear Button */}
                                {(('maskSvgUrl' in card && card.maskSvgUrl) || ('contentMediaUrl' in card && card.contentMediaUrl)) && (
                                  <Button
                                    type="button"
                                    variant="ghost"
                                    size="sm"
                                    onClick={() => updateFeaturedCard(index, { maskSvgUrl: "", contentMediaUrl: "", mediaUrl: "" })}
                            ...
                            <div className="mt-4">
                              ...
                              <div className="flex items-center space-x-4">
                                {card.mediaUrl && (
                                  <img src={card.mediaUrl} alt="Card media" className="w-16 h-16 object-cover rounded" />
                                )}
                                <Button 
                                  type="button" 
                                  variant="outline" 
                                ...
                                {card.mediaUrl && (
                                  <Button 
                                    type="button" 
                                    variant="ghost" 
                                    onClick={() => updateFeaturedCard(index, { mediaUrl: "" })}
                                  >
                                    Remove
                                  </Button>
                                )}
                          ...
                          {index === 1 && (
                            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded">
                              <h5 className="font-medium text-green-800 mb-2">Expandable Content Sections</h5>
                              <p className="text-sm text-green-600 mb-3">Define sections that appear when users expand this card</p>
                              {(formData.featuredContent.card2.expandedContent || []).map((section, sectionIndex) => (
                                <div key={sectionIndex} className="mb-3 p-2 border border-green-300 rounded bg-white">
                                  <div className="grid grid-cols-1 gap-2">
                                    <Input
                                      placeholder="Section title (e.g., Features)"
                                      value={section.title}
                                      onChange={(e) => {
                                        const newSections = [...(formData.featuredContent.card2.expandedContent || [])];
                                        newSections[sectionIndex] = { title: e.target.value, text: newSections[sectionIndex]?.text || "" };
                                        setFormData(prev => ({
                                          ...prev,
                                          featuredContent: {
                                            ...prev.featuredContent,
                                            card2: { ...prev.featuredContent.card2, expandedContent: newSections }
                                          }
                                        }));
                                      }}
                                      className="text-sm"
                                    ...
                                    <Textarea
                                      ...
                                      onChange={(e) => {
                                        const newSections = [...(formData.featuredContent.card2.expandedContent || [])];
                                        newSections[sectionIndex] = { title: newSections[sectionIndex]?.title || "", text: e.target.value };
                                        setFormData(prev => ({
                                          ...prev,
                                          featuredContent: {
                                            ...prev.featuredContent,
                                  ...
                                  <Button
                                    ...
                                    size="sm"
                                    onClick={() => {
                                      const newSections = (formData.featuredContent.card2.expandedContent || []).filter((_, i) => i !== sectionIndex);
                                      setFormData(prev => ({
                                        ...prev,
                                        featuredContent: {
                                          ...prev.featuredContent,
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  const newSections = [...(formData.featuredContent.card2.expandedContent || []), newSection];
                                  setFormData(prev => ({
                                    ...prev,
                                    featuredContent: {
                                      ...prev.featuredContent,
                          ...
                          {index === 2 && (
                            <div className="mt-4 p-3 bg-purple-50 border border-purple-200 rounded">
                              <h5 className="font-medium text-purple-800 mb-2">Flip Card Back Side Content</h5>
                              <p className="text-sm text-purple-600 mb-3">Content shown when the card is flipped</p>
                              ...
                              <div className="space-y-3">
                                  ...
                                  <Input
                                    ...
                                    onChange={(e) => {
                                      setFormData(prev => ({
                                        ...
                                        featuredContent: {
                                          ...prev.featuredContent,
                                          card3: { ...prev.featuredContent.card3, subtitle: e.target.value }
                                        }
                                      }));
                                    }}
                                    className="text-sm"
                                ...
                                <div>
                                  ...
                                  {(formData.featuredContent.card3.features || []).map((feature, featureIndex) => (
                                    <div key={featureIndex} className="flex items-center gap-2 mb-2">
                                      <Input
                                        placeholder="e.g., Premium Quality"
                                        value={feature}
                                        onChange={(e) => {
                                          const newFeatures = [...(formData.featuredContent.card3.features || [])];
                                          newFeatures[featureIndex] = e.target.value;
                                          setFormData(prev => ({
                                            ...prev,
                                            featuredContent: {
                                              ...prev.featuredContent,
                                              card3: { ...prev.featuredContent.card3, features: newFeatures }
                                            }
                                          }));
                                        }}
                                        className="text-sm"
                                      ...
                                      <Button
                                        ...
                                        size="sm"
                                        onClick={() => {
                                          const newFeatures = (formData.featuredContent.card3.features || []).filter((_, i) => i !== featureIndex);
                                          setFormData(prev => ({
                                            ...prev,
                                            featuredContent: {
                                              ...prev.featuredContent,
      ...
      <StandardMediaSelectionDialog
        ...
        title={
          mediaPickerTarget === 'card1-svg' ? 'Select SVG Mask File' :
          mediaPickerTarget === 'card1-media' ? 'Select Content Media' :
          'Select Media'
        }
