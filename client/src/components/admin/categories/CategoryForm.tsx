		...
		const submitData = {
			...
			featuredContent: {
				card1: {
					...
					description: (
						formData.featuredContent.card1.description || ""
					).trim(),
					mediaUrl:
				...
				card2: {
					...
					description: (
						formData.featuredContent.card2.description || ""
					).trim(),
					mediaUrl:
				...
				card3: {
					...
					description: (
						formData.featuredContent.card3.description || ""
					).trim(),
					mediaUrl:
				...
				card4: {
					...
					description: (
						formData.featuredContent.card4.description || ""
					).trim(),
					mediaUrl:
	...
	return (
		<>
			<EnhancedDialog open={open} onOpenChange={onClose}>
				<EnhancedDialogContent
					className="z-modal pointer-events-auto"
					contentType="form"
				>
					<EnhancedDialogHeader>
						<EnhancedDialogTitle>
								...
								<TabsContent value="featured">
									<Card>
										...
										<CardContent className="space-y-6">
											{[0, 1, 2, 3].map((index) => {
												const cardKey =
													`card${index + 1}` as keyof FormData["featuredContent"];
															...
															<div className="mt-4">
																<div className="p-3 bg-blue-50 border-2 border-blue-200 rounded-lg">
																	...
																	<p className="text-xs text-gray-600 mb-3">
																		Select an SVG file for the mask shape and a
																		video/image for the content
																	</p>
																	...
																	<div className="space-y-2">
																		...
																		<div className="flex items-center gap-2">
																			<Button
																				...
																				size="sm"
																				onClick={() =>
																					openMediaPicker("card1", "media")
																				}
																				className="flex items-center gap-2"
																			>
																				🎬 Browse Video/Images
																			</Button>
																			{"contentMediaUrl" in card &&
														...
														{index === 1 && (
															<div className="mt-4 p-3 bg-green-50 border border-green-200 rounded">
																...
																<p className="text-sm text-green-600 mb-3">
																	Define sections that appear when users expand
																	this card
																</p>
																{(
																	formData.featuredContent.card2
																		.expandedContent || []
																).map((section, sectionIndex) => (
																	<div
																		key={sectionIndex}
																		className="mb-3 p-2 border border-green-300 rounded bg-white"
																	>
																...
																<div className="space-y-3">
																	<div>
																		...
																		<Input
																			...
																			value={
																				formData.featuredContent.card3
																					.subtitle || ""
																			}
																			onChange={(e) => {
																				setFormData((prev) => ({
