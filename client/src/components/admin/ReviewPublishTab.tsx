...
export const ReviewPublishTab: React.FC<ReviewPublishTabProps> = ({
	...
	const validationItems: ValidationItem[] = [
		...
		},
		{
			...
			message: formData.categoryId
				? "Category assigned"
				: "Consider assigning a category",
		},
		// Media validations
		{
			level:
	...
	const getSizeChartName = (id: number | null): string => {
		...
		return chart
			? `${chart.name}${chart.category ? ` (${chart.category})` : ""}`
			: "Unknown";
	};
				...
				<div className="flex items-center justify-between">
					<div>
						...
						<p className="text-gray-600 mt-1">
							Final validation and publication controls
						</p>
					</div>
					...
					<div className="grid grid-cols-3 gap-4 mb-6">
						...
						<div className="text-center">
							<div className="text-2xl font-bold text-green-600">
								{
									validationItems.filter((item) => item.level === "success")
										.length
								}
							</div>
						...
						<div>
							...
							<div className="space-y-2 text-sm">
								<div>
									...
									{getCategoryName(formData.categoryId ?? null) ||
										"Not assigned"}
								</div>
								<div>
								...
								<div>
									...
									{getSizeChartName(formData.sizeChartId ?? null) ||
										"Not assigned"}
								</div>
							</div>
						</div>
