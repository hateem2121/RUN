...
export function PublicProcessSection({ mediaAssets, processes }: PublicProcessSectionProps) {
    ...
    <ManufacturingErrorBoundary>
      <section className="bg-zinc-50 py-16 md:py-32 dark:bg-transparent">
        <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl">
          ...
          >
            <h2 className="text-foreground mb-4 text-4xl font-bold">Manufacturing Processes</h2>
