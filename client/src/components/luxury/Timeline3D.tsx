			...
			<div className="container mx-auto px-4">
				...
				>
					...
					<p className="text-xl luxury-text-light max-w-3xl mx-auto leading-relaxed">
						From artisanal craftsmanship to modern innovation, discover the
						milestones that shaped RUN APPAREL's legacy of excellence.
					</p>
				</motion.div>
				...
				<div
					className="absolute bottom-20 right-10 w-24 h-24 glass-light rounded-full floating-element opacity-30"
