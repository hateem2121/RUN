...
export function PerformanceAnalysis() {
  ...
  const getMetricBadge = (value: number | null, thresholds: { good: number; poor: number }, unit: string = 'ms') => {
    if (value === null) return <Badge variant="secondary">N/A</Badge>;
    
    if (value <= thresholds.good) return <Badge className="bg-green-500">{formatMetric(value, unit)}</Badge>;
    if (value <= thresholds.poor) return <Badge className="bg-yellow-500">{formatMetric(value, unit)}</Badge>;
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-2">
              <h4 className="font-medium text-sm text-gray-600">Core Web Vitals</h4>
            ...
            {/* Bundle Performance */}
            <div className="space-y-2">
              <h4 className="font-medium text-sm text-gray-600">Bundle Performance</h4>
              ...
              <div className="flex justify-between items-center">
                ...
                {metrics.memoryUsage ? (
                  <Badge className={metrics.memoryUsage > 50 ? "bg-red-500" : metrics.memoryUsage > 30 ? "bg-yellow-500" : "bg-green-500"}>
            ...
            {/* Performance Tips */}
            <div className="space-y-2">
              <h4 className="font-medium text-sm text-gray-600">Optimization Status</h4>
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              ...
              lazy loading optimization, and real-time performance monitoring are now running. 
              Click "Run Full Analysis" to see detailed reports in the console.
            </p>
          </div>
        </CardContent>
      </Card>
