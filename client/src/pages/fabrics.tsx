...
export default function Fabrics() {
	...
	const [expandedFabrics, setExpandedFabrics] = useState<Set<number>>(
		new Set(),
	);
				...
				<div className="max-w-7xl mx-auto">
					...
					>
						...
						<p className="text-lg text-gray-600 max-w-3xl mx-auto">
							High-performance fabrics engineered for superior comfort,
														...
														return (
															...
															>
																<HoverCard3D maxRotation={10}>
																	<Card
																		className="h-full hover:shadow-lg transition-shadow-sm cursor-pointer overflow-hidden"
																			...
																			{(() => {
																				...
																				return defaultComp &&
																					...
																					<div className="space-y-2 mb-3">
																						...
																						{defaultComp.fibers.length > 2 &&
																							!isExpanded && (
																								<p className="text-xs text-gray-500">
																									+
																									{defaultComp.fibers.length -
																										2}{" "}
																									more fibers
																								</p>
																							)}
