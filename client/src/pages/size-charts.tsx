...
export default function SizeCharts() {
	...
	const groupedCharts = filteredCharts.reduce(
		(acc, chart) => {
						...
						<TableBody>
							{chart.measurements.map((measurement: any, idx: number) => (
								<TableRow key={idx}>
									...
									<TableCell>
										{convertMeasurement(measurement.chest, selectedUnit)}
									</TableCell>
									<TableCell>
										{convertMeasurement(measurement.waist, selectedUnit)}
									</TableCell>
									<TableCell>
										{convertMeasurement(measurement.hip, selectedUnit)}
									</TableCell>
									<TableCell>
										{convertMeasurement(measurement.length, selectedUnit)}
									</TableCell>
								</TableRow>
							))}
						</TableBody>
