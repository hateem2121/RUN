...
export default function Dashboard() {
  return (
    <div className="flex min-h-dvh flex-col bg-neutral-900 text-white selection:bg-blue-500/30">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-green-600 py-20">
        ...
        <div className="container relative z-modal-backdrop mx-auto px-4 text-center text-white">
          ...
          <motion.p
            ...
            className="mx-auto mb-8 max-w-3xl text-gray-100 text-xl md:text-2xl"
          >
