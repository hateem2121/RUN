        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <Card key={index} className="hover:shadow-lg transition-shadow-sm">
                <CardHeader>
          ...
          <div className="mt-16 bg-primary/5 rounded-2xl p-8 md:p-12">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {[
                ...
                { step: "2", title: "Development", desc: "Create samples and prototypes for approval" },
                { step: "3", title: "Production", desc: "Manufacture your order with quality control" },
                { step: "4", title: "Delivery", desc: "Ship your products worldwide on schedule" }
              ].map((item, index) => (
