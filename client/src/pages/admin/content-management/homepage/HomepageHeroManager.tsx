...
import type { HomepageHero, MediaAsset, HomepageSection } from "@shared/schema";
...
export function HomepageHeroManager({
  ...
  const updateHeroMutation = useMutation({
    mutationFn: async (data: Partial<HomepageHero>) => {
      console.log("🌐 [STEP 4: API REQUEST] Executing API request to backend");
      console.log("📤 Request data:", data);
      const result = await apiRequest("/api/homepage-hero", {
        method: "PATCH",
        body: data,
      });
      console.log("✅ [STEP 4: API RESPONSE] Backend responded successfully");
      console.log("📥 Response data:", result);
      return result;
    },
    onMutate: async (data) => {
      // Cancel outgoing queries
      await getQueryClient().cancelQueries({ queryKey: ["/api/homepage-hero"] });
    ...
    onError: (error, _variables, context) => {
      console.error("❌ [STEP 5: MUTATION ERROR] Failed to save hero");
    ...
    onSuccess: (data) => {
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      console.log("🎉 [STEP 5: MUTATION SUCCESS] Hero saved to database");
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
      console.log("📦 Saved data:", data);
      console.log("🔄 [CACHE INVALIDATION] Invalidating React Query cache keys");
      console.log('🔹 Keys to invalidate: ["/api/homepage-hero"], ["/api/homepage-batch"]');

      // Targeted cache invalidation to maintain hit rates
      getQueryClient().invalidateQueries({ queryKey: ["/api/homepage-hero"] });
      console.log('✅ [CACHE INVALIDATION] Invalidated: ["/api/homepage-hero"]');

      getQueryClient().invalidateQueries({ queryKey: ["/api/homepage-batch"] });
      console.log('✅ [CACHE INVALIDATION] Invalidated: ["/api/homepage-batch"]');

      console.log(
        "🔔 [REACT QUERY] This triggers automatic refetch for all components using these keys",
      );
      console.log("🔔 [REACT QUERY] Homepage component should receive updated hero data");
      console.log("⏭️  NEXT: Navigate to homepage (/) to see refetch trigger and STEP 6 logs");
      console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
  ...
  const handleSaveHero = () => {
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("💾 [STEP 4: SAVE TRIGGERED] User clicked Save Hero Section");
    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    console.log("🔹 Current heroForm state:", heroForm);
    console.log("🔹 backgroundImageId to save:", heroForm.backgroundImageId);
    ...
    console.log("📤 [STEP 4: SAVE] Sending to backend via PATCH /api/homepage-hero");
            ...
            <div className="space-y-2">
              ...
              {selectedMedia && (
                <div className="mt-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground mt-1">{selectedMedia.filename}</p>
                </div>
              )}
            </div>
