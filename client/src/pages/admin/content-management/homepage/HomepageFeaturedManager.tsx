		...
		<div className="space-y-6">
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Control the "Archive/Featured" section on the homepage.
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-6">
					<div className="flex items-center justify-between">
						...
						<Switch
							...
							onCheckedChange={(c) =>
								setFormState((prev) => ({ ...prev, isActive: c }))
							}
						/>
					</div>
					...
					<div className="grid gap-4">
						...
						<div className="flex items-center justify-between border-t pt-4">
							...
							<Switch
								...
								onCheckedChange={(c) =>
									setFormState((prev) => ({ ...prev, autoSelect: c }))
								}
							/>
						</div>
						...
						{!formState.autoSelect && (
							<div className="border rounded-md p-4">
								<Label className="mb-2 block">
									Manual Selection ({formState.selectedProductIds.length}/
									{formState.maxProducts})
								</Label>
								<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 max-h-60 overflow-y-auto">
									{products?.map((product) => (
										...
										>
											<Switch
												checked={formState.selectedProductIds.includes(
													product.id,
												)}
