...
export function HomepageFeaturedManager() {
  ...
  const updateSettingsMutation = useMutation({
    ...
    onSuccess: () => {
      getQueryClient().invalidateQueries({ queryKey: ["/api/homepage-featured-products-settings"] });
      toast({ title: "Success", description: "Featured products settings updated" });
    },
    onError: () => {
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <div className="text-sm text-muted-foreground">Show this section on homepage</div>
            </div>
            <Switch
                  ...
                  {products?.map((product) => (
                    ...
                    >
                      ...
                      <div className="text-sm truncate">
                        ...
                        <span className="text-xs text-gray-400 block">{product.sku}</span>
                      </div>
                    </div>
                  ))}
                </div>
