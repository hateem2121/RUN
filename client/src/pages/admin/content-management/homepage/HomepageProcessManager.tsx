...
export function HomepageProcessManager({
	...
	const [editingProcessCardId, setEditingProcessCardId] = useState<
		number | null
	>(null);
	...
	const updateProcessCardMutation = useMutation({
		mutationFn: async ({
			...
			id: number;
			data: Partial<HomepageProcessCard>;
		}) => {
		...
		<div className="space-y-6">
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<div className="grid gap-2">
							<Label htmlFor="process-section-title">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Manage cards showing your process/technology steps.
					</CardDescription>
				</CardHeader>
				<CardContent>
												...
												{processCardForm.iconMediaId && (
													<div className="relative w-10 h-10 border rounded overflow-hidden">
														...
														<img
															src={
																mediaAssets.find(
																	(a) => a.id === processCardForm.iconMediaId,
																)?.url || ""
															}
															alt="preview"
											...
											<div className="flex items-center gap-3 p-3 border rounded-lg bg-card">
												...
												<div className="flex items-center gap-2">
													...
													<Button
														...
														size="sm"
														onClick={() =>
															deleteProcessCardMutation.mutate(card.id)
														}
													>
