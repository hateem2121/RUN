...
export function HomepageStatsManager({ sectionData, onUpdateSection }: HomepageStatsManagerProps) {
  ...
  const handleAddItem = () => {
    setStats([
      ...stats,
      { id: crypto.randomUUID(), value: "0", label: "New Stat", description: "Description" },
    ]);
  };

  const handleUpdateItem = (index: number, field: keyof StatItem, value: string) => {
    ...
    <div className="space-y-6">
      {sectionData && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage visibility for the Stats section.</CardDescription>
          </CardHeader>
          <CardContent className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(checked) =>
                onUpdateSection?.({ id: sectionData.id, data: { isActive: checked } })
              }
            />
          </CardContent>
        </Card>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage the numbers and labels displayed in the scrolling stats section.
          </CardDescription>
        </CardHeader>
