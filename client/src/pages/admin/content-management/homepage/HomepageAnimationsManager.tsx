            ...
            <div className="space-y-4 py-4">
              {activeTab === "dot-grid" && (
                <div className="space-y-4">
                  <h3 className="font-medium text-lg">Dot Grid Settings</h3>
              ...
              {activeTab === "liquid-glass" && (
                <div className="space-y-4">
                  <h3 className="font-medium text-lg">Liquid Glass Distortion</h3>
                  <div className="space-y-2">
              ...
              {activeTab === "swipe" && (
                <div className="space-y-4">
                  <h3 className="font-medium text-lg">Swipe Thresholds</h3>
                  <div className="space-y-2">
