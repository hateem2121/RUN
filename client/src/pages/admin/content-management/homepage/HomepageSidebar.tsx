  ...
  return (
    <div className="flex h-full flex-col gap-2">
      <div className="border-b px-4 py-2">
        ...
        <p className="text-muted-foreground text-xs">Manage order & visibility</p>
      </div>
          ...
          {menuItems.map((item) => {
            ...
            return (
              <div
                key={item.key}
                className={cn(
                  "group flex items-center justify-between rounded-md px-3 py-2 font-medium text-sm transition-colors hover:bg-accent hover:text-accent-foreground",
