		...
		<div className="container mx-auto p-6 max-w-7xl">
			<div className="mb-6">
				...
				<p className="text-muted-foreground">
					Automated testing for upload/delete cache synchronization and
			...
			<Card className="mb-6">
				<CardHeader>
					...
					<CardDescription>
						Run comprehensive tests to verify cache invalidation and data
						synchronization
					</CardDescription>
				</CardHeader>
				<CardContent>
										...
										<div className="grid grid-cols-3 gap-4 text-sm">
											<div>
												...
												<p className="font-mono">
													{results.summary.cachePerformance.avgInvalidationTime.toFixed(
														1,
													)}
													ms
												</p>
											...
											<div>
												...
												<p className="font-mono">
													{results.summary.cachePerformance.avgRefetchTime.toFixed(
														1,
													)}
													ms
												</p>
													...
													<div className="mt-4 p-3 bg-muted rounded">
														...
														<div className="grid grid-cols-3 gap-2 text-xs">
															...
															<div>
																...
																<p className="font-mono">
																	{result.cacheMetrics.refetchDuration}ms
																</p>
															</div>
															<div>
																<p className="text-muted-foreground">
																...
																<p className="font-mono">
																	{result.cacheMetrics.dataConsistency
																		? "YES"
																		: "NO"}
																</p>
															</div>
