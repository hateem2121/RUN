				...
				<TabsContent value="general" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Main animation settings and visibility controls
							</CardDescription>
						</CardHeader>
							...
							<div className="space-y-2">
								...
								<div className="flex items-center gap-4">
									<Slider
										...
										step={0.1}
										value={[
											parseFloat(settings.animationDurationMultiplier ?? "1.0"),
										]}
										onValueChange={([value]) =>
											value !== undefined &&
											setSettings({
									...
									<span className="w-12 text-sm text-right">
										{parseFloat(
											settings.animationDurationMultiplier ?? "1.0",
										).toFixed(1)}
										x
									</span>
								</div>
						...
						<CardContent className="space-y-6">
							...
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(value) =>
										setSettings({ ...settings, drawEasing: value })
									}
								>
				...
				<TabsContent value="motion" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Configure floating elements using createMotionPath
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<div className="flex items-center justify-between">
							...
							<div className="space-y-2">
								<Label htmlFor="motionElements">
									Motion Elements (comma-separated)
								</Label>
								<input
									id="motionElements"
									type="text"
								...
								/>
								<p className="text-sm text-gray-500">
									Elements to animate (string array)
								</p>
							</div>
							...
							<div className="space-y-2">
								...
								<p className="text-sm text-gray-500">
									Duration of motion path animations
								</p>
							</div>
						</CardContent>
					</Card>
				...
				<TabsContent value="advanced" className="space-y-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Developer options and custom styling
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							<div className="space-y-2">
								...
								<input
									...
									onChange={(e) =>
										setSettings({ ...settings, customCssClass: e.target.value })
									}
							...
							<div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
								...
								<p className="text-sm text-amber-700 mt-3">
									Animations load homepage content in the background to improve
