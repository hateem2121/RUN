        ...
        <Dialog open={!!selectedInquiry} onOpenChange={() => setSelectedInquiry(null)}>
          <DialogContent className="max-w-2xl" data-testid="dialog-inquiry-detail">
            <DialogHeader>
              ...
              <DialogDescription>
                Submitted on{" "}
                {selectedInquiry && new Date(selectedInquiry.submittedAt).toLocaleString()}
              </DialogDescription>
            </DialogHeader>
            {selectedInquiry && (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <Label>Country</Label>
                    <p className="font-medium" data-testid="text-detail-country">
                ...
                {selectedInquiry.adminNotes && (
                  <div>
                    ...
                    <p className="mt-2 whitespace-pre-wrap rounded-md bg-yellow-50 p-3 dark:bg-yellow-900/20">
                      {selectedInquiry.adminNotes}
                    </p>
                  </div>
                )}
