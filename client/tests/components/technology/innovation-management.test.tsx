...
const MockTechnologyInnovationManagement = ({ isLoading: _isLoading }: { isLoading?: boolean }) => {
  const [innovationForm, setInnovationForm] = React.useState({
    ...
    specifications: { Material: "Carbon Fiber", Weight: "50g/m²" } as Record<string, string>,
    impactMetrics: { "Energy Savings": "30%", Durability: "200%" } as Record<string, string>,
    imageId: null,
    videoId: null,
    isActive: true,
  });
