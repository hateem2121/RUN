...
export const TECHNOLOGY_THEME = {
  colors: {
    // Stitch cobalt/cyan palette
    primary: '#0047AB',       // Cobalt (light mode)
    accent: '#00D4FF',        // Cyan (dark mode)
    primaryLight: '#2E74D9',  // Cobalt light
    primaryDark: '#002F75',   // Cobalt dark
    glow: 'rgba(0, 212, 255, 0.25)', // Cyan glow
  },
};
