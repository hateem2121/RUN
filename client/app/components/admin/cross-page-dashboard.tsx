...
export function CrossPageDashboard() {
  ...
  useGSAP(
    () => {
      ...
      gsap.from(".dashboard-col", { opacity: 0, y: 20, duration: 0.5, stagger: 0.1 });
    },
    { scope: dashboardGridRef },
  );
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <div ref={dashboardGridRef} className="grid grid-cols-1 gap-6 md:grid-cols-3">
            {/* Sustainability Impact */}
            <div className="dashboard-col space-y-4">
