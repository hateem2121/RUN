...
export default function AdminCMS() {
  ...
  useGSAP(
    () => {
      if (!moduleGridRef.current) return;
      gsap.from(".module-card", { opacity: 0, y: 20, duration: 0.4, stagger: 0.05 });
    },
    { scope: moduleGridRef },
  );
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      {/* CMS Module Grid */}
      <div ref={moduleGridRef} className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {modules.map((module) => (
