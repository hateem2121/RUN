...
export function TechnologyCtaManagement() {
  ...
  const updateCtaMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Success", { description: "CTA section updated successfully" });
    },
  });
    ...
    <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            <h2 className="text-3xl font-black tracking-tight text-white uppercase sm:text-4xl">
              CTA <span className="text-custom-color-86">Configuration</span>
            </h2>
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="group h-11 border-none bg-custom-color-87 px-8 font-bold text-custom-color-88 transition-all hover:bg-custom-color-89/90 hover:shadow-custom-misc-96 active:scale-95 disabled:bg-custom-color-90/50"
            >
      ...
      {isLoading ? (
        <div className="space-y-6">
          <div className="h-custom-space-107 w-full animate-pulse rounded-2xl bg-white/[0.02]" />
          <div className="h-custom-space-108 w-full animate-pulse rounded-2xl bg-white/[0.02]" />
        </div>
      ) : (
          ...
          <div className="space-y-8 lg:col-span-8">
            <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-xl">
              <div className="mb-8 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-custom-color-91/10 text-custom-color-92 ring-1 ring-custom-color-93/20 shadow-custom-misc-97">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-xxs font-black uppercase tracking-custom-misc-98 text-admin-muted">
                    Primary Headline
                  </Label>
                  <Input
                    value={ctaForm.headline}
                    onChange={(e) => setCtaForm((prev) => ({ ...prev, headline: e.target.value }))}
                    className="h-14 border-white/5 bg-white/[0.03] text-lg font-bold text-white focus:border-custom-color-94/40"
                    placeholder="Get Started Today..."
                  />
                </div>
                <div className="space-y-2">
                  <Label className="text-xxs font-black uppercase tracking-custom-misc-99 text-admin-muted">
                    Supporting Content
                  </Label>
                  <Textarea
                    value={ctaForm.content}
                    onChange={(e) => setCtaForm((prev) => ({ ...prev, content: e.target.value }))}
                    className="h-custom-space-109 resize-none border-white/5 bg-white/[0.03] text-admin-foreground focus:border-custom-color-95/40"
            ...
            <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-xl">
              <div className="mb-8 flex items-center gap-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-purple-500/10 text-purple-400 ring-1 ring-purple-500/20 shadow-custom-misc-100">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-2">
                  <Label className="text-xxs font-black uppercase tracking-custom-misc-101 text-admin-muted">
                    Button Descriptor
                  </Label>
                  <Input
                    ...
                    className="h-12 border-white/5 bg-white/[0.03] text-white focus:border-custom-color-96/40"
                    placeholder="Contact Us..."
                  />
                </div>
                <div className="space-y-2">
                  <Label className="text-xxs font-black uppercase tracking-custom-misc-102 text-admin-muted">
                    Destination Link
                  </Label>
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className="h-12 border-white/5 bg-white/[0.03] pl-10 text-custom-color-97 focus:border-custom-color-98/40"
                      placeholder="/contact..."
                    />
                  </div>
                </div>
          ...
          <div className="space-y-8 lg:col-span-4">
            ...
            <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-xl shadow-2xl">
              <div className="mb-6 flex items-center justify-between">
                <h3 className="text-xs font-black uppercase tracking-custom-misc-103 text-admin-muted">
                  Ecosystem Status
                </h3>
                <Badge
                  className={
                    ctaForm.isActive
                      ? "bg-custom-color-99 text-custom-color-100"
              ...
              <div className="flex items-center justify-between rounded-2xl border border-white/5 bg-white/[0.03] p-4 ring-1 ring-white/5">
                <div className="flex items-center gap-3">
                  <div
                    className={cn(
                      ...
                      ctaForm.isActive ? "bg-custom-color-101" : "bg-white/20",
                    )}
                  />
                ...
                <Switch
                  ...
                  className="data-custom-misc-104:bg-custom-color-102"
                />
              </div>
            </div>
            ...
            <div className="rounded-3xl border border-white/5 bg-white/[0.02] p-8 backdrop-blur-xl">
              <div className="mb-6 space-y-2">
                <h3 className="text-sm font-black text-white uppercase tracking-custom-misc-105 italic">
                  Solution Benefits
                </h3>
              ...
              <div className="mb-6 space-y-3">
                {ctaForm.benefits.map((benefit, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <CheckCircle2 className="h-4 w-4 text-custom-color-103/60" />
              ...
              <div className="space-y-3 pt-4 border-t border-white/5">
                ...
                <Button
                  ...
                  className="w-full bg-custom-color-104/10 text-admin-foreground hover:bg-custom-color-105/20"
                >
                  ADD BENEFIT VECTOR
                </Button>
              </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 backdrop-blur-xl">
          <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-custom-color-106/10 text-custom-color-107">
