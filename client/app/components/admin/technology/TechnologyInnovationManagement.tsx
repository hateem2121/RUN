  ...
  return (
    ...
    >
      <button
        ...
        {...attributes}
        {...listeners}
        className="cursor-move p-1 text-admin-muted hover:text-cyan-400 transition-colors bg-transparent border-0 outline-hidden focus:ring-2 focus:ring-cyan-500/50 rounded"
    ...
    return (
      <div className="flex flex-col items-center justify-center py-40 gap-4">
        <div className="flex space-x-2">
          <div className="h-2 w-2 animate-pulse rounded-full bg-cyan-500 [animation-delay:-0.3s]"></div>
          <div className="h-2 w-2 animate-pulse rounded-full bg-cyan-500 [animation-delay:-0.15s]"></div>
