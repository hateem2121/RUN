import type { Category, Fabric, Product } from "@shared/index";
import {
  Archive,
  Calendar,
  Filter,
...
export function ProductAdvancedFilters({
  ...
  const filteredAndSortedProducts = useMemo(() => {
    ...
    const filtered = searchFilteredProducts.filter((product) => {
      ...
      // Fabric filter
      const matchesFabric = fabricFilter === "all" || product.fabricId?.toString() === fabricFilter;
      ...
      return matchesStatus && matchesCategory && matchesFabric && matchesFeatured;
    });
