...
type ProductFormAction =
  ...
  | { type: "ADD_TO_ARRAY"; field: keyof ProductFormState; value: any }
  ...
  switch (action.type) {
    ...
    case "LOAD_PRODUCT": {
      ...
      return {
        ...
        leadTime: p.leadTime || "",
        customWeight: (p as any).customWeight || "",
        customFit: (p as any).customFit || "",
...
export function useProductForm(product?: Product | null) {
  ...
  const addToArray = useCallback((field: keyof ProductFormState, value: any) => {
