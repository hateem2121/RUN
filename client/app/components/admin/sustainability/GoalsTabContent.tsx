...
import type { InsertSustainabilityGoal, SustainabilityGoal } from "@shared/index";
...
interface GoalsTabContentProps {
  ...
  createGoalMutation: UseMutationResult<SustainabilityGoal, Error, InsertSustainabilityGoal>;
  updateGoalMutation: UseMutationResult<
    SustainabilityGoal,
    Error,
    { id: number; data: Partial<InsertSustainabilityGoal> }
  >;
...
export function GoalsTabContent({
  ...
  return (
    <>
      <TabsContent value="goals" className="outline-hidden">
            ...
            <div className="flex w-full items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  className="h-12 px-8 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold uppercase text-xxs tracking-widest shadow-lg shadow-emerald-500/20 active:scale-95 transition-all outline-hidden focus-visible:ring-2 focus-visible:ring-emerald-500 border-0"
                >
            ...
            <div className="aspect-[9/16] w-full max-w-[280px] rounded-huge border-[8px] border-white/10 bg-black overflow-hidden relative shadow-2xl ring-1 ring-white/5 p-6">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xxs text-white/50 leading-relaxed line-clamp-4">
