...
import { sanitizeCssValue, sanitizeCssVariableName } from "@/lib/sanitize-html";
...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: styles needed
