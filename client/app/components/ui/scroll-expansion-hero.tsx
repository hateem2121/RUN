...
const ScrollExpandMedia = ({
  ...
  // Animate background opacity based on scroll progress
  useGSAP(
    () => {
      if (!bgRef.current) return;
      gsap.to(bgRef.current, { opacity: 1 - scrollProgress, duration: 0.1, overwrite: true });
    },
    { dependencies: [scrollProgress] },
  );

  // Animate content section opacity based on showContent
  useGSAP(
    () => {
      ...
      <section className="relative flex min-h-screen flex-col items-center justify-start">
        <div className="relative flex min-h-screen w-full flex-col items-center">
          ...
          <div className="container relative z-elevated mx-auto flex flex-col items-center justify-start">
            <div className="relative flex min-h-[100dvh] w-full flex-col items-center justify-center pt-28 md:pt-32 pb-20">
              <div
