...
export const headingVariants = cva("text-balance font-bold break-words transition-colors", {
  variants: {
    variant: {
    ...
    <Component
      ref={
        ref as unknown as React.Ref<
          HTMLElement & HTMLParagraphElement & HTMLSpanElement & HTMLDivElement & HTMLLabelElement
        >
      }
