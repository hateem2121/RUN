...
function IconItem({
  ...
  return (
    <Link
      to={href}
      aria-label={title}
      className="group flex min-h-11 flex-col items-center gap-2 rounded-xl focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
    >
      <div
      ...
      >
        ...
        <div
          className="dock-icon-wrapper center-flex relative z-elevated"
