  ...
  private performGsapCleanup = () => {
    try {
      if (typeof window !== "undefined") {
        ...
        const gsapInstance = (window as unknown as { gsap?: GSAPInstance }).gsap;
        if (gsapInstance) {
        ...
        const scrollTrigger = (window as unknown as { ScrollTrigger?: ScrollTriggerInstance })
          .ScrollTrigger;
        if (scrollTrigger) {
  ...
  private renderFallbackUI() {
    ...
    return (
      <div className="relative rounded-2xl border border-red-200 bg-red-50 p-6 text-center">
        <div className="center-flex mb-4">
          {isRecovering ? (
