              ...
              return fabric ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="-my-1 -mr-1 ml-2 flex min-h-11 min-w-11 items-center justify-center hover:text-red-500 focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:text-red-500"
