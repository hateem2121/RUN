      ...
      <section className="py-24 border-t border-white/5 bg-manufacturing-bg overflow-hidden relative">
        ...
        >
          {galleries.map((item, idx) => (
            <div
              key={idx}
              className={`min-w-[400px] md:min-w-[500px] ${item.h} relative group snap-center flex-shrink-0 bg-manufacturing-card border border-white/10 overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(212,168,83,0.1)] hover:border-manufacturing-accent/50`}
            >
