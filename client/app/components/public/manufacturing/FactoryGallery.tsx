  ...
  return (
    <ManufacturingErrorBoundary>
      <section className="py-24 border-t border-white/5 bg-manufacturing-bg overflow-hidden relative">
        <div className="absolute inset-0 bg-custom-misc-162 from-manufacturing-accent/10 via-manufacturing-bg to-manufacturing-bg pointer-events-none"></div>

        <div className="max-w-7xl mx-auto px-6 mb-12 flex flex-col md:flex-row justify-between items-end relative z-10 gap-6">
          <div>
            <h2 className="text-4xl font-neue-stance font-bold text-white uppercase mb-2 italic skew-x-custom-misc-163">
            ...
            <div className="flex items-center gap-2 text-manufacturing-muted text-xs font-mono uppercase tracking-widest mt-4">
              <div className="flex items-center gap-1 border-b border-gray-600 pb-1">
                ...
                <div className="w-8 h-custom-space-177 bg-manufacturing-accent/80"></div>
          ...
          <div className="flex flex-col items-center justify-center pointer-events-none md:pointer-events-auto">
            <div className="flex items-center space-x-2 text-white font-mono text-sm border-l-4 border-manufacturing-accent px-4 py-2 bg-black/80 backdrop-blur-sm skew-x-custom-misc-164 shadow-lg shadow-manufacturing-accent/10">
        ...
        <div
          ref={scrollRef}
          className="overflow-x-auto pb-12 pl-6 md:pl-custom-misc-165 pr-6 flex items-end gap-6 snap-x snap-mandatory h-custom-space-178 scrollbar-hide no-scrollbar relative z-10"
        >
          {galleries.map((item, idx) => (
            <div
              key={idx}
              className={`min-w-custom-space-179 md:min-w-custom-space-180 ${item.h} relative group snap-center flex-shrink-0 bg-manufacturing-card border border-white/10 overflow-hidden transition-all duration-300 hover:shadow-custom-misc-166 hover:border-manufacturing-accent/50`}
            >
              <div className="absolute top-4 left-4 z-20 text-custom-space-181 font-mono uppercase tracking-widest text-manufacturing-accent border border-manufacturing-accent bg-black/80 px-2 py-1 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 font-bold">
                {item.camMsg}
              </div>

              <div className="absolute inset-0 z-10 pointer-events-none mix-blend-overlay opacity-60 bg-custom-misc-167"></div>
              ...
              <div className="absolute bottom-0 left-0 w-full p-6 z-20 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                <h3 className="text-3xl font-neue-stance font-black text-white uppercase tracking-wider mb-1 italic skew-x-custom-misc-168">
                  {item.title}
                </h3>
