...
export function PublicCapabilitySection({}: PublicCapabilitySectionProps) {
  return (
    <ManufacturingErrorBoundary>
      <section className="py-24 max-w-7xl mx-auto px-6 bg-[#121212]">
        <div className="mb-16 text-center">
          <span className="text-[#D4A853] font-mono text-xs uppercase tracking-widest border border-[#D4A853]/30 px-3 py-1 rounded-none font-bold">
            Core Competencies
          </span>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 grid-rows-none lg:grid-rows-2 gap-6 min-h-[800px] lg:min-h-[600px]">
          ...
          <div className="col-span-2 row-span-1 lg:row-span-2 border border-white/5 bg-white/[0.04] p-8 relative overflow-hidden group backdrop-blur-xl transition-colors hover:border-[#D4A853]/40">
            <div className="absolute top-0 right-0 p-4 opacity-40 group-hover:opacity-100 transition-opacity">
              <Factory className="size-10 text-[#D4A853]" />
            </div>
            <div className="relative z-10 h-full flex flex-col justify-end">
              ...
              <a
                className="text-[#D4A853] text-sm font-bold uppercase tracking-widest hover:text-white transition-colors flex items-center gap-2 group/link cursor-pointer w-fit"
                href="#contact"
              >
                Learn More{" "}
            ...
            <div className="absolute inset-0 z-0 bg-gradient-to-t from-[#0A0A0A]/95 via-transparent to-transparent"></div>
            <img
          ...
          <div className="col-span-2 lg:col-span-1 row-span-1 border border-white/5 bg-white/[0.04] p-6 relative overflow-hidden group backdrop-blur-xl hover:border-[#D4A853]/60 transition-colors">
            <div className="flex flex-col h-full justify-between">
              <FlaskConical className="size-8 text-[#D4A853] mb-4" />
              <div>
          ...
          <div className="col-span-2 lg:col-span-1 row-span-1 border border-white/5 bg-white/[0.04] p-6 relative overflow-hidden group backdrop-blur-xl hover:border-[#D4A853]/60 transition-colors">
            <div className="flex flex-col h-full justify-between">
              <Recycle className="size-8 text-[#D4A853] mb-4" />
              <div>
                <h3 className="text-xl font-neue-stance font-bold text-white mb-2 italic uppercase tracking-wider">
                  Sustainable Tech
                </h3>
          ...
          <div className="col-span-2 lg:col-span-1 row-span-1 lg:row-span-2 border border-white/5 bg-white/[0.04] p-6 relative overflow-hidden group backdrop-blur-xl hover:border-[#D4A853]/60 transition-colors">
            <div className="absolute top-0 right-0 p-4 opacity-40 group-hover:opacity-100 transition-opacity">
              <Truck className="size-8 text-[#D4A853]" />
            </div>
            <div className="flex flex-col h-full justify-between relative z-10">
              <div className="mt-auto">
                ...
                <div className="h-24 w-full bg-[#0A0A0A]/50 rounded-sm mt-4 relative overflow-hidden border border-[#D4A853]/10">
                  <div className="absolute inset-0 opacity-10 bg-[radial-gradient(ellipse_at_center,_#D4A853_0%,_transparent_70%)]"></div>
                  <div className="absolute top-1/2 left-1/4 w-1.5 h-1.5 bg-[#D4A853] rotate-45 animate-pulse"></div>
                  <div
                    className="absolute top-1/3 left-1/2 w-1.5 h-1.5 bg-[#D4A853] rotate-45 animate-pulse"
                    style={{ animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="absolute top-2/3 right-1/4 w-1.5 h-1.5 bg-[#D4A853] rotate-45 animate-pulse"
          ...
          <div className="col-span-1 lg:col-span-1 row-span-1 border border-white/5 bg-white/[0.04] p-6 relative overflow-hidden group backdrop-blur-xl hover:border-[#D4A853]/60 transition-colors">
            <div className="flex flex-col h-full justify-between">
              <Bot className="size-8 text-[#D4A853] mb-4" />
              <div>
                <h3 className="text-xl font-neue-stance font-bold text-white mb-2 italic uppercase tracking-wider">
                  Robotics
                </h3>
          ...
          <div className="col-span-1 lg:col-span-1 row-span-1 border border-white/5 bg-white/[0.04] p-6 relative overflow-hidden group backdrop-blur-xl hover:border-[#D4A853]/60 transition-colors">
            <div className="flex flex-col h-full justify-between">
              <ShieldCheck className="size-8 text-[#D4A853] mb-4" />
              <div>
                <h3 className="text-xl font-neue-stance font-bold text-white mb-2 italic uppercase tracking-wider">
                  QC Protocols
                </h3>
