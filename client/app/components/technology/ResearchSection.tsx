               ...
               <div className="p-8 md:flex gap-8">
                  <div className="md:w-2/3">
                     ...
                     {item.objectives && item.objectives.length > 0 && (
                       <div className="mb-6">
                         <h4 className="text-sm font-semibold text-white/70 uppercase tracking-wider mb-3">Objectives</h4>
                  ...
                  <div className="md:w-1/3 mt-8 md:mt-0 flex flex-col justify-between border-t md:border-t-0 md:border-l border-white/10 pt-6 md:pt-0 md:pl-8">
                     <div className="space-y-6">
                        {item.startDate && (
                           <div>
                              <span className="block text-xs uppercase text-white/40 mb-1">Start Date</span>
                              <span className="text-white font-mono">{item.startDate}</span>
                           </div>
                        )}
                        {item.expectedCompletion && (
                           <div>
                              <span className="block text-xs uppercase text-white/40 mb-1">Target Completion</span>
