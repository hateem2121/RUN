      ...
      <div className="container mx-auto px-4 z-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {innovations.map((item) => (
            <Card key={item.id} className="bg-black/40 border-white/10 backdrop-blur-md overflow-hidden hover:border-primary/50 transition-colors duration-300">
               <div className="p-6 h-full flex flex-col">
                  ...
                  {item.benefits.length > 0 && (
                    <div className="space-y-2">
                      <p className="text-sm font-semibold text-white/50 uppercase tracking-wider">Key Benefits</p>
