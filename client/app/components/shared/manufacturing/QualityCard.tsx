...
export function QualityCard({ quality, index, mediaAssets }: QualityCardProps) {
  ...
  useGSAP(
    () => {
      if (isChecked && checkIconRef.current) {
        gsap.from(checkIconRef.current, {
          scale: 0,
          rotate: -180,
          duration: 0.4,
          ease: "back.out(1.7)",
    ...
    { scope: checkIconRef, dependencies: [isChecked] },
  );
        ...
        <CardHeader className="pb-1">
          <div className="p-3">
            <div className="flex items-start justify-between">
              ...
              {gridSpan.colSpan >= 2 && isChecked && (
                <div ref={checkIconRef} className="ml-2">
