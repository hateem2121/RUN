...
async function seedSizeCharts() {
  try {
    ...
    const newCharts = [
      {
        ...
        region: "US",
        type: "Apparel",
        description: "Engineered for our Active Wear lines. These measurements assume a \"Second Skin\" fit using high-elastane fabric.",
        measurements: {
          "XS (0-2)": { "Waist": "61-64", "Hip": "86-89", "Inseam": "69", "Thigh": "50" },
          "S (4-6)": { "Waist": "66-69", "Hip": "91-94", "Inseam": "71", "Thigh": "53" },
          "M (8-10)": { "Waist": "71-74", "Hip": "96-99", "Inseam": "71", "Thigh": "56" },
          "L (12-14)": { "Waist": "77-81", "Hip": "102-105", "Inseam": "74", "Thigh": "60" },
          "XL (16-18)": { "Waist": "86-90", "Hip": "110-114", "Inseam": "74", "Thigh": "65" }
        },
        isActive: true
      },
      {
        ...
        region: "INTL",
        type: "Apparel",
        description: "A versatile chart for Casual Wear and corporate programs. We utilize \"Linear Grading\" here to accommodate taller athletes in larger sizes without the garment becoming boxy.",
        measurements: {
      ...
      },
      {
        ...
        region: "INTL",
        type: "Accessories",
        description: "Precision sizing for our high-performance Sports Accessories. Glove fit is critical for ball control.",
        measurements: {
    ...
    console.log(`✅ Successfully added ${inserted.length} size charts:`);
    inserted.forEach(chart => {
      console.log(`- ${chart.name} (ID: ${chart.id})`);
    });
