...
async function testReplitServicesIntegration() {
	...
	const objectStorageResult = await fetchAPI(
		"/api/media/test/object-storage-connectivity",
	);
	...
	const dbIntegrityResult = await fetchAPI(
		"/api/media/debug/repair-database-integrity",
		{
			method: "POST",
		},
	);
