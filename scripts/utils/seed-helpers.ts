...
export function generateDescription(minWords: number = 10, maxWords: number = 30): string {
    const words = [
        'innovative', 'sustainable', 'premium', 'advanced', 'professional', 'cutting-edge',
        'eco-friendly', 'durable', 'lightweight', 'breathable', 'moisture-wicking',
        'performance', 'comfort', 'quality', 'technology', 'design', 'manufacturing',
        'production', 'materials', 'fabrics', 'craftsmanship', 'excellence', 'standards',
        'certification', 'environmental', 'responsibility', 'innovation', 'research',
        'development', 'facilities', 'equipment', 'processes', 'capabilities'
    ];
...
export const SampleData = {
    colors: [
        'Navy Blue', 'Black', 'White', 'Royal Blue', 'Red', 'Forest Green',
        'Gray', 'Charcoal', 'Light Blue', 'Purple', 'Orange', 'Yellow',
        'Maroon', 'Burgundy', 'Teal', 'Sky Blue', 'Olive', 'Khaki'
    ],

    sizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL'],

    productCategories: [
        'Athletic Wear', 'Casual Sportswear', 'Team Sports',
        'Outdoor & Adventure', 'Corporate & Workwear', 'Accessories'
    ],

    firstNames: [
        'John', 'Sarah', 'Michael', 'Emily', 'David', 'Jessica',
        'James', 'Jennifer', 'Robert', 'Lisa', 'William', 'Karen'
    ],
    ...
    companyNames: [
        'Tech Innovations Inc', 'Global Solutions Ltd', 'Future Dynamics Corp',
        'Premier Sports Co', 'Elite Performance Group', 'Summit Athletics',
        'Apex Apparel', 'Momentum Brands', 'Catalyst Sports', 'Pinnacle Wear'
    ],
