...
const accessoriesData = [
	...
	},
	{
		...
		description:
			'Essential for our "Outer Wear" and "Tracksuits". In sports, a zipper pull that bounces around is a distraction. We utilize auto-lock cam technology where the pull tab stays locked in place when flush against the zipper chain. The Vislon (molded plastic) teeth are lighter than metal and corrosion-resistant, making them perfect for sweat-heavy environments and all-weather training gear.',
		specifications: {
	...
	},
	{
		...
		description:
			'The industry standard for high-performance activewear. We replace scratchy woven tags with smooth, skin-friendly heat transfers applied directly to the inside neck or waistband. This "Friction-Free" branding prevents irritation during intense movement (running/training) and provides a clean, professional canvas for our partner\'s sizing and care data.',
		specifications: {
