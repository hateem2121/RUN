...
async function comprehensiveSeedDatabase() {
  try {
    console.log('📊 Phase 1: Database Cleanup & Preparation');

    // Step 1: Clear existing data in proper order (respecting foreign keys)
    ...
    console.log('📊 Phase 2: Foundation Data - Materials & Certifications');

    // Step 2: Seed Fibers (Base materials)
    console.log('🧬 Seeding fibers...');
    const fiberData = [
      {
        name: 'Polyester',
        type: 'synthetic',
        description: 'Synthetic fiber known for durability and moisture-wicking properties',
        sustainabilityScore: 6,
        environmentalImpact: 'Made from petroleum-based materials but highly durable and recyclable',
        properties: { synthetic: true, durable: true, quickDry: true, affordable: true },
        isActive: true
      },
      {
        name: 'Cotton',
        ...
        environmentalImpact: 'Renewable natural resource, biodegradable, requires significant water',
        properties: { natural: true, breathable: true, comfortable: true, biodegradable: true },
        isActive: true
      },
      {
        name: 'Nylon',
        ...
        environmentalImpact: 'Petroleum-based synthetic with high durability but energy-intensive production',
        properties: { synthetic: true, strong: true, elastic: true, lightweight: true },
        isActive: true
      },
      {
        name: 'Spandex',
        ...
        environmentalImpact: 'Petroleum-based with complex chemical processing, difficult to recycle',
        properties: { synthetic: true, highElasticity: true, flexible: true, recovery: true },
        isActive: true
      },
      {
        name: 'Merino Wool',
        ...
        environmentalImpact: 'Renewable, biodegradable, naturally antimicrobial, ethical sourcing important',
        properties: { natural: true, thermoRegulation: true, antimicrobial: true, premium: true },
        isActive: true
      },
      {
        name: 'Bamboo',
        ...
        sustainabilityScore: 9,
        environmentalImpact: 'Fast-growing renewable resource, naturally antibacterial, minimal water needed',
        properties: { natural: true, sustainable: true, antibacterial: true, soft: true },
        isActive: true
      }
    ];

    const insertedFibers = await db.insert(fibers).values(fiberData).returning();
    console.log(`✅ Seeded ${insertedFibers.length} fibers`);
    ...
    const certificateData = [
      ...
      },
      {
        ...
        description: 'Organic fiber certification with environmental and social criteria',
    ...
    // Step 4: Seed Enhanced Fabrics with relationships
    console.log('🧵 Seeding enhanced fabrics...');
    const fabricData = [
      {
        name: 'Moisture-Wicking Polyester',
        description: 'Advanced polyester fabric engineered for moisture management',
    ...
    console.log(`✅ Seeded ${insertedFabrics.length} enhanced fabrics`);

    console.log('📊 Phase 3: Product Categorization');
    ...
    const categoryData = [
      {
        name: 'Athletic Wear',
        slug: 'athletic-wear',
        description: 'High-performance athletic clothing designed for sports and fitness activities',
        isActive: true,
        displayOrder: 1
      },
      {
      ...
      },
      {
        name: 'Team Sports',
        slug: 'team-sports',
        description: 'Specialized uniforms and gear for team sports and organizations',
        isActive: true,
        displayOrder: 3
      },
      {
        ...
        description: 'Weather-resistant clothing for outdoor activities and adventures',
        isActive: true,
        displayOrder: 4
      },
      {
    ...
    const insertedSizeCharts = await db.insert(sizeCharts).values(sizeChartData).returning();
    console.log(`✅ Seeded ${insertedSizeCharts.length} size charts`);

    console.log('📊 Phase 4: Comprehensive Product Catalog');

    // Step 7: Seed Comprehensive Products
    ...
    const productData = [
      // Athletic Wear Products
      {
        ...
        description: 'High-performance running shirt engineered with advanced moisture-wicking technology and UV protection for serious athletes.',
        ...
        moq: 50,
        leadTime: '14-21 days',
        availableColors: ['Navy Blue', 'Black', 'White', 'Royal Blue', 'Red', 'Forest Green'],
        availableSizes: ['XS', 'S', 'M', 'L', 'XL', 'XXL'],
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Logo printing, embroidery, sublimation, color matching, reflective elements',
      ...
      },
      {
        ...
        description: 'Premium training shorts with advanced mesh panels, secure pockets, and ergonomic fit for all-day comfort.',
        ...
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Side stripes, logo placement, custom colors, pocket configurations',
        sampleAvailability: true,
      ...
      },
      {
        ...
        description: 'Full-length compression leggings with muscle support technology and flatlock seams for reduced chafing.',
        ...
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Side panels, logo placement, waistband colors, length variations',
        sampleAvailability: true,
      ...
      // Casual Sportswear Products
      {
        ...
        description: 'Classic polo shirt made with premium cotton blend featuring reinforced seams and fade-resistant colors.',
        ...
        moq: 75,
        leadTime: '12-18 days',
        availableColors: ['White', 'Navy', 'Gray', 'Light Blue', 'Green', 'Black'],
        availableSizes: ['S', 'M', 'L', 'XL', 'XXL'],
        isFeatured: false,
        isActive: true,
        customizationOptions: 'Embroidered logos, custom buttons, collar variations, pocket additions',
        sampleAvailability: true,
      ...
      },
      {
        ...
        description: 'Sustainable hoodie made from recycled materials with kangaroo pocket and adjustable drawstring hood.',
        ...
        moq: 25,
        leadTime: '18-25 days',
        availableColors: ['Heather Gray', 'Navy', 'Black', 'Maroon', 'Forest Green'],
        availableSizes: ['S', 'M', 'L', 'XL', 'XXL'],
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Full zip options, embroidered logos, color blocking, pocket styles',
        sampleAvailability: true,
      ...
      // Team Sports Products
      {
        ...
        description: 'Professional soccer jersey with advanced moisture management, reinforced stress points, and sublimation-ready fabric.',
        ...
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Full sublimation printing, team logos, player names, numbers, sponsor logos',
        sampleAvailability: true,
      ...
      },
      {
        ...
        description: 'Lightweight basketball practice jersey with mesh side panels for maximum ventilation during intense training.',
        ...
        isFeatured: false,
        isActive: true,
        customizationOptions: 'Screen printing, heat transfer, numbering systems, contrast panels',
        sampleAvailability: true,
      ...
      // Outdoor & Adventure Products
      {
        ...
        description: 'Versatile windbreaker with water-resistant coating, packable design, and reflective details for outdoor adventures.',
        ...
        isFeatured: true,
        isActive: true,
        customizationOptions: 'Reflective strips, hood options, pocket configurations, DWR coating levels',
        sampleAvailability: true,
      ...
      // Corporate & Workwear Products
      {
        ...
        description: 'Professional polo shirt perfect for corporate uniforms with stain-resistant treatment and professional fit.',
        ...
        isFeatured: false,
        isActive: true,
        customizationOptions: 'Embroidered corporate logos, monogramming, custom color matching',
        sampleAvailability: true,
        fiberComposition: '60% Cotton, 40% Polyester with stain-resistant finish',
        displayOrder: 9
      }
    ];

    const insertedProducts = await db.insert(products).values(productData).returning();
    console.log(`✅ Seeded ${insertedProducts.length} comprehensive products`);

    // Step 8: Seed Accessories
    ...
    const accessoryData = [
      {
        ...
        category: 'athletic',
        specifications: { material: 'Terry cotton blend', size: 'One size fits most' },
        isActive: true
      },
      {
        name: 'Team Socks',
    ...
    const insertedAccessories = await db.insert(accessories).values(accessoryData).returning();
    console.log(`✅ Seeded ${insertedAccessories.length} accessories`);

    console.log('📊 Phase 5: Media Assets & Relationships');

    // Step 9: Seed Media Assets
    console.log('🖼️ Seeding comprehensive media assets...');
    const mediaData = [
      // Athletic Wear Media
      {
    ...
    console.log(`✅ Seeded ${insertedMedia.length} media assets`);

    // Step 10: Link Products with Media Assets
    console.log('🔗 Establishing product-media relationships...');
    const mediaLinks = [
    ...
    for (const link of mediaLinks) {
      if (insertedProducts[link.productIndex] && insertedMedia[link.mediaIndex]) {
    ...
    console.log(`✅ Linked ${linkedCount} products with media assets`);

    console.log('📊 Phase 6: Data Verification & Summary');
    ...
    console.log(`🧵 Fabrics: ${finalCounts.fabrics}`);
    console.log(`🧬 Fibers: ${finalCounts.fibers}`);
    console.log(`🏆 Certificates: ${finalCounts.certificates}`);
    console.log(`📏 Size Charts: ${finalCounts.sizeCharts}`);
    console.log(`👕 Products: ${finalCounts.products}`);
    console.log(`🎽 Accessories: ${finalCounts.accessories}`);
    console.log(`🖼️ Media Assets: ${finalCounts.mediaAssets}`);
    console.log(`🔗 Product-Media Links: ${finalCounts.linkedProducts}`);
    console.log('==========================================');
