	...
	try {
		...
		const categoryData = [
			{
				...
				slug: "athletic-wear",
				description:
					"High-performance athletic clothing for sports and fitness",
				isActive: true,
				displayOrder: 1,
			},
			{
		...
		const productData = [
			// Athletic Wear Products
			{
				...
				description:
					"High-performance running shirt with moisture-wicking technology",
			...
			},
			{
				...
				description:
					"Lightweight training shorts with side pockets and drawstring waist",
			...
			// Casual Wear Products
			{
				...
				description:
					"Classic polo shirt made with premium cotton blend for everyday wear",
				...
				customizationOptions:
					"Embroidered logos, custom buttons, collar variations",
				sampleAvailability: true,
			...
			},
			{
				...
				description:
					"Stylish track jacket perfect for casual wear and light workouts",
			...
			// Team Sports Products
			{
				...
				description:
					"Professional soccer jersey with advanced moisture management",
				...
				isActive: true,
				customizationOptions:
					"Team logos, player names, numbers, sublimation printing",
				sampleAvailability: true,
				fiberComposition: "100% Polyester",
				displayOrder: 5,
			},
			...
			// Outdoor Gear Products
			{
				...
				description:
					"Lightweight windbreaker with water-resistant coating for outdoor activities",
				...
				isActive: true,
				customizationOptions:
					"Reflective strips, hood options, pocket configurations",
				sampleAvailability: true,
