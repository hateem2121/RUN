  ...
  try {
    ...
    const fabricData = [
      ...
      },
      {
        ...
        properties: { breathable: true, flexible: true, moistureManagement: true },
      ...
      },
      {
        ...
        properties: { thermalInsulation: true, softTouch: true, sustainable: true },
        careInstructions: 'Machine wash cold, tumble dry low',
        isActive: true
      }
    ];
    ...
    // Step 5: Seed Sample Media Assets
    ...
    // Step 6: Update products with media associations  
    console.log('🔗 Linking products with media...');
    ...
    console.log('✅ Products linked with media');
    ...
    console.log(`   Media Assets: ${insertedMedia.length}`);
