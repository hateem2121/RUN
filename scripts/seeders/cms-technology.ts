...
export async function seedTechnologyHero(): Promise<SeedResult> {
    return seedWithTransaction('technologyHero', async () => {
        const heroImages = await db.select().from(mediaAssets).where(eq(mediaAssets.filename, 'hero-technology.jpg'));
        ...
        const heroData = {
            ...
            description: 'Our investment in cutting-edge technology enables us to deliver superior quality, faster turnaround, and innovative solutions.',
...
export async function seedTechnologyInnovations(): Promise<SeedResult> {
    return seedWithTransaction('technologyInnovations', async () => {
        const innovationsData = [
            {
                ...
                description: 'Seamless garment construction using advanced 3D knitting machines for enhanced comfort and fit',
                category: 'manufacturing',
                benefits: ['Zero waste production', 'Enhanced durability', 'Perfect fit', 'Faster production'],
            ...
            },
            {
                ...
                description: 'Precision laser cutting for intricate patterns and designs with minimal fabric waste',
                category: 'cutting',
                benefits: ['99.9% accuracy', 'Complex designs', 'Reduced waste', 'Faster processing'],
            ...
            },
            {
                ...
                description: 'AI-powered visual inspection system detecting defects with 99.5% accuracy',
                category: 'quality',
                benefits: ['Consistent quality', 'Early defect detection', 'Reduced waste', '24/7 monitoring'],
            ...
            },
            {
                ...
                description: 'Water-based digital printing for vibrant, eco-friendly designs',
                category: 'printing',
                benefits: ['Unlimited colors', 'Eco-friendly', 'Small batch capable', 'Fast turnaround'],
            ...
            },
            {
                ...
                description: 'RFID-based inventory tracking providing real-time stock visibility',
                category: 'logistics',
                benefits: ['Real-time tracking', 'Reduced errors', 'Optimized storage', 'Faster fulfillment'],
                developmentYear: '2021',
                isActive: true,
                sortOrder: 5
            },
            {
                ...
                description: 'In-house lab testing fabric durability, moisture management, and performance',
                category: 'research',
                benefits: ['Quality assurance', 'Data-driven decisions', 'Innovation testing', 'Certification support'],
                developmentYear: '2022',
                isActive: true,
                sortOrder: 6
            }
        ...
        return await db.insert(technologyInnovations).values(innovationsData).returning();
    });
}
...
export async function seedTechnologyEquipment(): Promise<SeedResult> {
    return seedWithTransaction('technologyEquipment', async () => {
        ...
        const equipmentImages = allMedia.filter(m => m.filename?.startsWith('equipment-'));
        ...
        const equipmentData = [
            {
                ...
                model: 'MACH2XS',
                quantity: 12,
                capabilities: ['Seamless construction', '3D design', 'Multi-color knitting'],
            ...
            },
            {
                ...
                quantity: 8,
                capabilities: ['Multi-layer cutting', 'Laser precision', 'CAD integration'],
            ...
            },
            {
                ...
                description: 'High-performance industrial sewing with precision stitching',
                category: 'sewing',
                manufacturer: 'Brother',
                model: 'S-7300A',
                quantity: 150,
                capabilities: ['High-speed operation', 'Consistent stitch quality', 'Low maintenance'],
            ...
            },
            {
                ...
                description: 'Advanced digital printing for vibrant, eco-friendly designs',
                category: 'printing',
                manufacturer: 'Mimaki',
                model: 'TS300P-1800',
                quantity: 6,
            ...
            },
            {
                ...
                model: 'TFMX-II',
                quantity: 10,
                capabilities: ['15-head system', 'Up to 15 colors', 'High-speed operation'],
        ...
        return await db.insert(technologyEquipment).values(equipmentData).returning();
    });
}
        ...
        const researchData = [
            {
                ...
                description: 'Developing high-performance fabrics that biodegrade at end of life',
            ...
            },
            {
                ...
                description: 'Embedding sensors and conductive threads for performance tracking',
            ...
            },
            {
                ...
                description: 'Machine learning algorithms for optimal pattern layouts and minimal waste',
    ...
    return seedWithTransaction('technologyRoadmap', async () => {
        const roadmapData = [
            ...
            },
            {
                ...
                description: 'Predictive quality analytics to prevent defects before production',
                timeline: 'Q1 2026',
                category: 'quality',
                priority: 'high',
                isActive: true,
            ...
            },
            {
                ...
                description: 'Complete elimination of production waste through circular processes',
                timeline: 'Q2 2026',
...
export async function seedTechnologyGradientSettings(): Promise<SeedResult> {
    return seedWithTransaction('technologyGradientSettings', async () => {
        ...
        return await db.insert(technologyGradientSettings).values(gradientData).returning();
    });
}
        ...
        const ctaData = [
            {
                ...
                description: 'Schedule a virtual facility tour to see our advanced equipment and processes firsthand',
                ctaText: 'Book a Tour',
            ...
            },
            {
                ...
                description: 'Collaborate with our R&D team on cutting-edge textile technology projects',
