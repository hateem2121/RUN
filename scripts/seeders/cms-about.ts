...
export async function seedAboutHero(): Promise<SeedResult> {
    return seedWithTransaction('aboutHero', async () => {
        const heroImages = await db.select().from(mediaAssets).where(eq(mediaAssets.filename, 'hero-about.jpg'));
        const heroImageId = heroImages[0]?.id || null;

        const heroData = {
            title: 'Our Story',
            subtitle: 'Crafting Quality Sportswear Since 2010',
            description: 'From a small workshop to a global B2B manufacturing powerhouse, our journey has been defined by innovation, quality, and unwavering commitment to our clients.',
...
export async function seedAboutSections(): Promise<SeedResult> {
    return seedWithTransaction('aboutSections', async () => {
        const sectionsData = [
            {
                title: 'Our Mission',
                content: 'To empower brands worldwide with premium, sustainable sportswear through innovative manufacturing and exceptional service.',
                sectionType: 'text',
                position: 1,
                isActive: true,
                sortOrder: 1
            ...
            {
                title: 'Our Vision',
                content: 'To be the global leader in B2B sportswear manufacturing, setting industry standards for quality, sustainability, and innovation.',
                sectionType: 'text',
                position: 2,
                isActive: true,
                sortOrder: 2
            ...
            {
                title: 'Our Values',
                content: 'Quality First • Sustainable Practices • Innovation • Customer Partnership • Social Responsibility',
                sectionType: 'list',
                position: 3,
                isActive: true,
                sortOrder: 3
            ...
            {
                title: 'Why Choose Us',
                content: '15+ years of manufacturing excellence, 1000+ satisfied clients, ISO-certified facilities, and commitment to environmental sustainability.',
            ...
            {
                title: 'Our Expertise',
                content: 'Specializing in athletic wear, team uniforms, corporate apparel, and custom sportswear with cutting-edge fabric technology.',
            ...
            {
                title: 'Global Reach',
                content: 'Serving clients across 40+ countries with manufacturing facilities in Asia and distribution centers worldwide.',
                sectionType: 'global',
                position: 6,
                isActive: true,
                sortOrder: 6
...
export async function seedAboutTeamMessages(): Promise<SeedResult> {
    return seedWithTransaction('aboutTeamMessages', async () => {
        ...
        const teamImages = allMedia.filter(m => m.filename?.startsWith('team-member-'));
        ...
        const teamData = [
            {
                ...
                message: 'Our commitment to quality and sustainability drives everything we do. We believe in creating not just products, but partnerships that last.',
            ...
            },
            {
                ...
                message: 'Technology and tradition blend seamlessly in our facilities. We embrace innovation while respecting the craftsmanship that defines quality.',
            ...
            },
            {
                ...
                message: 'Every garment that leaves our facility meets the highest standards. Our team takes pride in delivering excellence with every order.',
            ...
            },
            {
                ...
                message: 'Sustainability isn\'t a buzzword for us—it\'s a responsibility. We\'re committed to reducing our environmental impact while maintaining quality.',
...
export async function seedAboutTimelineEntries(): Promise<SeedResult> {
    return seedWithTransaction('aboutTimelineEntries', async () => {
        const timelineData = [
            {
                ...
                description: 'Started as a small workshop with a vision for quality sportswear manufacturing',
                position: 1,
                isActive: true,
                sortOrder: 1
            },
            {
                ...
                description: 'Expanded operations to serve clients beyond domestic markets',
                position: 2,
                isActive: true,
                sortOrder: 2
            },
            ...
            },
            {
                ...
                description: 'Launched comprehensive sustainability program with renewable energy and waste reduction',
                position: 4,
                isActive: true,
                sortOrder: 4
            },
            {
                ...
                description: 'Invested $5M in state-of-the-art manufacturing equipment and automation',
                position: 5,
                isActive: true,
                sortOrder: 5
            },
            {
                ...
                description: 'Opened new facilities and expanded to 40+ countries worldwide',
                position: 6,
                isActive: true,
                sortOrder: 6
            },
            {
                ...
                description: 'Achieved Global Organic Textile Standard certification for sustainable practices',
                position: 7,
                isActive: true,
                sortOrder: 7
            },
            {
                ...
                description: 'Established R&D facility for fabric technology and product development',
                position: 8,
                isActive: true,
                sortOrder: 8
            },
            {
                ...
                description: 'Achieved carbon neutral manufacturing through renewable energy and offset programs',
                position: 9,
                isActive: true,
                sortOrder: 9
            },
            {
                year: '2024',
                title: '1000+ Clients',
                description: 'Reached milestone of serving over 1000 satisfied clients globally',
                position: 10,
                isActive: true,
                sortOrder: 10
            }
        ...
        return await db.insert(aboutTimelineEntries).values(timelineData).returning();
    });
}
