...
export async function seedEnhancedMediaAssets(): Promise<SeedResult> {
    return seedWithTransaction('mediaAssets', async () => {
        ...
        const teamRoles = ['CEO', 'CTO', 'Head of Manufacturing', 'Design Lead', 'Quality Manager',
            'Production Manager', 'Marketing Director', 'Sales Manager', 'R&D Lead', 'Sustainability Officer'];
        for (let i = 1; i <= 10; i++) {
            mediaData.push({
        ...
        const heroSections = ['homepage', 'about', 'manufacturing', 'sustainability', 'technology', 'products', 'contact', 'team'];
        ...
        const mfgProcesses = ['cutting', 'sewing', 'quality-check', 'packaging', 'warehouse', 'shipping'];
        ...
        const sustainTopics = ['recycling', 'solar-panels', 'water-conservation', 'green-certification'];
