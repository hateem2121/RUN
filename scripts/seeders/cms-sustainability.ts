...
export async function seedSustainabilityHero(): Promise<SeedResult> {
    return seedWithTransaction('sustainabilityHero', async () => {
        const heroImages = await db.select().from(mediaAssets).where(eq(mediaAssets.filename, 'hero-sustainability.jpg'));
        ...
        const heroData = {
            ...
            description: 'Our commitment to sustainability goes beyond compliance—it\'s embedded in every decision we make, from material sourcing to energy consumption.',
            imageId: heroImageId,
            videoId: null,
            isActive: true
        };
        ...
        const initiativesData = [
            {
                ...
                description: '80% of our manufacturing facilities now powered by renewable solar energy, reducing carbon emissions by 45% since 2020.',
                category: 'energy',
            ...
            },
            {
                ...
                description: 'Advanced water treatment and recycling system recovers 60% of water used in dyeing and finishing processes.',
                category: 'water',
            ...
            },
            {
                ...
                description: 'Comprehensive waste management system diverts 90% of production waste from landfills through recycling and repurposing.',
                category: 'waste',
            ...
            },
            {
                ...
                description: 'Prioritizing organic cotton, recycled polyester, and biodegradable materials across our product lines.',
                category: 'materials',
            ...
            },
            {
                ...
                description: 'Partnership with certified carbon offset projects to achieve carbon neutrality across all operations.',
                category: 'carbon',
        ...
        const featuresData = [
            {
                ...
                description: 'Global Organic Textile Standard certified organic cotton from verified sustainable farms',
                category: 'materials',
                icon: 'Leaf',
                isActive: true,
                sortOrder: 1
