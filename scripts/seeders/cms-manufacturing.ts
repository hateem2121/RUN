...
export async function seedManufacturingHero(): Promise<SeedResult> {
    return seedWithTransaction('manufacturingHero', async () => {
        const heroImages = await db.select().from(mediaAssets).where(eq(mediaAssets.filename, 'hero-manufacturing.jpg'));
        const heroImageId = heroImages[0]?.id || null;

        const heroData = {
            title: 'State-of-the-Art Manufacturing',
            subtitle: 'Where Innovation Meets Precision',
            description: 'Our cutting-edge facilities combine advanced technology with skilled craftsmanship to deliver premium quality sportswear at scale.',
            imageId: heroImageId,
...
export async function seedManufacturingProcesses(): Promise<SeedResult> {
    return seedWithTransaction('manufacturingProcesses', async () => {
        ...
        const processesData = [
            {
                ...
                description: 'Every roll of fabric undergoes rigorous quality inspection before entering production. We verify weight, composition, and performance characteristics.',
                step: 1,
                duration: '2-4 hours',
            ...
            },
            {
                ...
                description: 'CAD-designed patterns optimized for minimal waste. Automated cutting systems ensure precision and consistency across all sizes.',
                step: 2,
                duration: '4-6 hours',
            ...
            },
            {
                ...
                description: 'Skilled seamstresses use industrial-grade equipment. Multiple quality checkpoints ensure perfect stitching and construction.',
                step: 3,
                duration: '6-8 hours',
            ...
            },
            {
                ...
                description: 'Multi-stage inspection process checking fit, finish, and functionality. Each garment must pass 15+ quality checkpoints.',
                step: 4,
                duration: '2-3 hours',
            ...
            },
            {
                ...
                description: 'Professional finishing touches including pressing, tagging, and custom packaging per client specifications.',
                step: 5,
                duration: '3-4 hours',
            ...
            },
            {
                ...
                description: 'Efficient logistics system with real-time tracking. Global shipping capabilities with express options available.',
                step: 6,
                duration: '1-2 days',
        ...
        return await db.insert(manufacturingProcesses).values(processesData).returning();
    });
}
    ...
    return seedWithTransaction('manufacturingCapabilities', async () => {
        const capabilitiesData = [
            ...
            },
            {
                ...
                description: 'High-definition full-color printing with unlimited design possibilities',
                category: 'printing',
                icon: 'Printer',
                isActive: true,
                sortOrder: 2
            },
            {
                ...
                description: 'Premium embroidery for logos and branding in up to 15 colors',
                category: 'embroidery',
                icon: 'Scissors',
                isActive: true,
                sortOrder: 3
            ...
            },
            {
                name: 'Size Grading',
                title: 'Size Grading',
                description: 'Complete size runs from XS to 5XL with custom sizing available',
                category: 'sizing',
                icon: 'Maximize',
                isActive: true,
                sortOrder: 6
            ...
            },
            {
                ...
                description: 'Custom branding, tags, and labels for your brand identity',
                category: 'branding',
                icon: 'Tag',
                isActive: true,
                sortOrder: 8
        ...
        return await db.insert(manufacturingCapabilities).values(capabilitiesData).returning();
    });
}
    ...
    return seedWithTransaction('manufacturingQualities', async () => {
        const qualitiesData = [
            ...
            },
            {
                ...
                description: 'Comprehensive fabric testing for durability, colorfastness, and performance',
                icon: 'TestTube',
                category: 'testing',
            ...
            },
            {
                ...
                description: 'Minimum 12 stitches per inch with reinforced stress points',
                icon: 'Target',
            ...
            },
            {
                ...
                description: 'Grade 4-5 colorfastness to washing, light, and perspiration',
                icon: 'Droplet',
                category: 'fabric',
        ...
        return await db.insert(manufacturingQualities).values(qualitiesData).returning();
    });
}
