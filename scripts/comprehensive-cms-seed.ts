...
async function comprehensiveCMSSeeding() {
  try {
    console.log("📊 Phase 1: CMS Content Cleanup & Preparation");

    // Clear CMS content tables (preserve core business data)
    console.log("🧹 Clearing CMS content data...");
    ...
    console.log("✅ CMS content data cleared");

    console.log("📊 Phase 2: Homepage Management Content");
    ...
    console.log(`✅ Seeded ${insertedHomepageHero.length} homepage hero entries`);

    // Homepage Slogans
    console.log("💬 Seeding homepage slogans...");
    ...
    const insertedHomepageSlogans = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedHomepageSlogans.length} homepage slogans`);

    // Homepage Process Cards
    console.log("⚙️ Seeding homepage process cards...");
    ...
    const insertedProcessCards = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedProcessCards.length} homepage process cards`);
    ...
    const homepageSectionData = [
      {
        ...
        data: {
          ...
          metrics: { experience: "20+ Years", capacity: "1M+ Units/Month", clients: "150+ Brands" },
        },
        isActive: true,
        sortOrder: 1,
      },
    ...
    const insertedHomepageSections = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedHomepageSections.length} homepage sections`);

    console.log("📊 Phase 3: About Page Management Content");
    ...
    console.log(`✅ Seeded ${insertedAboutHero.length} about hero entries`);
    ...
    const insertedAboutTimeline = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedAboutTimeline.length} about timeline entries`);

    // About Locations
    console.log("🗺️ Seeding about locations...");
    ...
    const insertedAboutLocations = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedAboutLocations.length} about locations`);

    // About Statistics
    console.log("📊 Seeding about statistics...");
    ...
    const insertedAboutStatistics = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedAboutStatistics.length} about statistics`);

    console.log("📊 Phase 4: Sustainability Management Content");

    // Sustainability Hero
    console.log("🌱 Seeding sustainability hero...");
    ...
    const insertedSustainabilityHero = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedSustainabilityHero.length} sustainability hero entries`);
    ...
    const insertedSustainabilityMetrics = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedSustainabilityMetrics.length} sustainability metrics`);

    console.log("📊 Phase 5: Manufacturing Management Content");
    ...
    const insertedManufacturingProcesses = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedManufacturingProcesses.length} manufacturing processes`);

    console.log("📊 Phase 6: Technology Management Content");

    // Technology Innovations
    console.log("🔬 Seeding technology innovations...");
    ...
    const insertedTechnologyInnovations = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedTechnologyInnovations.length} technology innovations`);
    ...
    const insertedFooterConfig = await db
      ...
      .returning();
    console.log(`✅ Seeded ${insertedFooterConfig.length} footer configuration`);
    ...
    console.log("\n📋 COMPREHENSIVE CMS SEEDING COMPLETED ✅");
    console.log("==========================================");
    console.log(`🎯 Homepage Hero: ${finalCMSCounts.homepageHero}`);
    console.log(`💬 Homepage Slogans: ${finalCMSCounts.homepageSlogans}`);
    console.log(`⚙️ Homepage Process Cards: ${finalCMSCounts.homepageProcessCards}`);
    console.log(`📄 Homepage Sections: ${finalCMSCounts.homepageSections}`);

    console.log(`🏢 About Hero: ${finalCMSCounts.aboutHero}`);
    console.log(`📅 About Timeline: ${finalCMSCounts.aboutTimeline}`);
    console.log(`🗺️ About Locations: ${finalCMSCounts.aboutLocations}`);
    console.log(`📊 About Statistics: ${finalCMSCounts.aboutStatistics}`);
    console.log(`🌱 Sustainability Hero: ${finalCMSCounts.sustainabilityHero}`);
    console.log(`📈 Sustainability Metrics: ${finalCMSCounts.sustainabilityMetrics}`);
    console.log(`🏭 Manufacturing Processes: ${finalCMSCounts.manufacturingProcesses}`);
    console.log(`🔬 Technology Innovations: ${finalCMSCounts.technologyInnovations}`);
    console.log(`🦶 Footer Configuration: ${finalCMSCounts.footerConfiguration}`);
    console.log("==========================================");
...
comprehensiveCMSSeeding()
  .then((results) => {
    console.log("✅ Comprehensive CMS seeding completed successfully!");
