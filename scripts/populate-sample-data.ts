			...
			const sampleFabrics = [
				{
					...
					description:
						"Advanced moisture-wicking fabric with quick-dry technology",
					composition: [
				...
				},
				{
					...
					description:
						"Environmentally conscious fabric blend with recycled content",
					composition: [
				...
				},
				{
					...
					description:
						"High-performance compression fabric for athletic applications",
					composition: [
	...
	try {
		...
		if (!hero || Object.keys(hero).length === 0) {
			const heroData = {
				...
				subtitle:
					"Quality athletic apparel for teams, brands, and organizations worldwide",
				description:
