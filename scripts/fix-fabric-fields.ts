...
async function fixAllFabrics() {
  try {
    console.log("🔧 Updating fabrics with correct field structure...\n");
      ...
      .set({
        ...
        properties: {
          ...
          compositions: [
            ...
            { name: "Promo-Poly", isDefault: false, fibers: [{ fiberId: 35, percentage: "100" }] },
          ],
        },
      })
      .where(eq(fabrics.name, "RunTech™ Aero-Mesh 145"));
    console.log("✅ Updated RunTech™ Aero-Mesh 145");
    ...
    console.log("✅ Updated Sculpt-Core™ 260");
    ...
    console.log("✅ Updated Heritage French Terry 350");
    ...
    console.log("✅ Updated Storm-Shield™ 3L Softshell");
    ...
    console.log("✅ Updated Zen-Luxe™ Performance Jersey");
      ...
      .set({
        ...
        properties: {
          ...
          compositions: [
            ...
            { name: "Pure-Merino", isDefault: false, fibers: [{ fiberId: 32, percentage: "100" }] },
            {
              name: "Merino-Blend",
              isDefault: false,
              fibers: [
    ...
    console.log("✅ Updated Thermo-Skin™ Pro");
    ...
    console.log("✅ Updated Eco-Flex™ Scuba 3.0");
    ...
    console.log("✅ Updated Velocity™ Diamond Ripstop");

    console.log("\n🎉 All fabrics updated with correct field structure!");
    process.exit(0);
  } catch (error) {
