...
export const AsteriskIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 100 100" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M50 10 L54.33 45.67 H90 L58.83 68.33 L71.66 97 L50 78 L28.34 97 L41.17 68.33 L10 45.67 H45.67 L50 10 Z" transform="scale(0.8) translate(12, 2)" />
        <path d="M50 10 L54.33 45.67 H90 L58.83 68.33 L71.66 97 L50 78 L28.34 97 L41.17 68.33 L10 45.67 H45.67 L50 10 Z" transform="scale(0.8) translate(12, 2) rotate(45 50 50)" />
    </svg>
);
...
export const CubeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 16.811V8.19c0-.864-.933-1.406-1.683-.977l-7.108 4.061a1.125 1.125 0 01-1.125 0L3.683 7.211A1.125 1.125 0 003 8.19v8.622c0 .864.933 1.406 1.683.977l7.108-4.061a1.125 1.125 0 011.125 0l7.108 4.061A1.125 1.125 0 0021 16.811z" />
    </svg>
);
