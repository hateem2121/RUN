...
export const mockProduct: Product = {
  ...
  media: [
    {
      ...
      thumbnail: 'https://images.pexels.com/photos/8636605/pexels-photo-8636605.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    },
    {
        type: MediaType.Image,
        src: 'https://images.pexels.com/photos/1939485/pexels-photo-1939485.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
        thumbnail: 'https://images.pexels.com/photos/1939485/pexels-photo-1939485.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    },
    {
      type: MediaType.Model3D,
      // Placeholder 3D model from Google. Replace with an actual product model.
      src: 'https://modelviewer.dev/shared-assets/models/Astronaut.glb',
      thumbnail: 'https://images.pexels.com/photos/2085739/pexels-photo-2085739.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    },
    {
      type: MediaType.Video,
      src: 'https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerFun.mp4',
      thumbnail: 'https://images.pexels.com/photos/1670977/pexels-photo-1670977.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    },
    {
        type: MediaType.Image,
        src: 'https://images.pexels.com/photos/270085/pexels-photo-270085.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
        thumbnail: 'https://images.pexels.com/photos/270085/pexels-photo-270085.jpeg?auto=compress&cs=tinysrgb&w=300&h=300&dpr=2',
    },
  ],
  availableColors: [
  ...
  compatibleAccessories: [
    { id: 'RA-GEAR-005', name: 'RUNVENT™ Performance Cap', category: 'RUN GEAR', imageUrl: 'https://images.unsplash.com/photo-1529958030586-3aae4ca485ff?q=80&w=2670&auto=format&fit=crop' },
    { id: 'RA-EVERYDAY-012', name: 'RUNKNIT™ Training Jogger', category: 'EVERYDAY RUN', imageUrl: 'https://images.unsplash.com/photo-1594499468122-8118c7346857?q=80&w=2670&auto=format&fit=crop' },
    { id: 'RA-GEAR-002', name: 'RUNGRIP™ All-Weather Gloves', category: 'RUN GEAR', imageUrl: 'https://images.unsplash.com/photo-1590431313623-02425666e537?q=80&w=2574&auto=format&fit=crop' },
    { id: 'RA-AS-ONE-003', name: 'RUNMESH™ Team Shorts', category: 'RUN AS ONE', imageUrl: 'https://images.unsplash.com/photo-1591104838614-25535b71a04a?q=80&w=2670&auto=format&fit=crop' },
    { id: 'RA-GEAR-010', name: 'Custom Soccer Ball', category: 'RUN GEAR', imageUrl: 'https://images.unsplash.com/photo-1551958214-2d5e204a2c5a?q=80&w=2670&auto=format&fit=crop' },
  ],
  detailImages: [
    { src: 'https://images.unsplash.com/photo-1604176354204-9268737828e4?q=80&w=2574&auto=format&fit=crop', alt: 'Close-up of a high-performance fabric weave' },
    { src: 'https://images.unsplash.com/photo-1576053139418-dd53a1a1f0a2?q=80&w=2574&auto=format&fit=crop', alt: 'Detailed view of durable flatlock stitching' },
  ]
};