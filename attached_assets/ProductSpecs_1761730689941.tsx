			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8">
				...
				>
					...
					<p className="text-gray-600 max-w-2xl mx-auto">
						Every detail is meticulously engineered for performance, durability,
						and customization. We provide full transparency into our materials
						and processes.
					</p>
				</motion.div>
					...
					<motion.div variants={itemVariants} className="space-y-12">
						<div>
							...
							<p className="text-gray-600 text-sm mb-6">
								Standard measurements are provided below. As a custom
								manufacturer, we can tailor sizing, fit, and grading to your
