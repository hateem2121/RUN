    ...
    <div>
      <main>
        <motion.div 
          ...
          animate="visible"
        >
            <motion.div ref={galleryContainerRef} variants={itemVariants} className="w-full lg:w-3/5">
              <ProductGallery 
                ref={galleryRef}
            ...
            <motion.div variants={itemVariants} className="w-full lg:w-2/5 lg:sticky lg:top-0 lg:h-screen">
              <ProductInfo 
                product={mockProduct} 
