export const routeManifest: Record<string, string> = {
  ...
  "/admin/certifications": "app/routes/admin.$module.tsx",
  "/admin/size-charts": "app/routes/admin.$module.tsx",
  "/admin/accessories": "app/routes/admin.$module.tsx",
  "/admin/resources": "app/routes/admin.$module.tsx",
  "/admin/collections": "app/routes/admin.$module.tsx",
  "/admin/gallery": "app/routes/admin.$module.tsx",
