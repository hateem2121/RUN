...
export const categories = pgTable(
	...
	(table) => [
		...
		index("categories_active_created_idx").on(
			table.isActive,
...
export const mediaAssets = pgTable(
	...
	(table) => [
		...
		index("media_active_created_idx").on(
			table.isActive,
			table.createdAt.desc(),
		),
...
export const fabrics = pgTable(
	"fabrics",
	{
		...
		visualSwatchId: integer("visual_swatch_id").references(
			() => mediaAssets.id,
			{
				onDelete: "set null",
			},
...
export const homepageFeaturedProductsSettings = pgTable(
...
export const manufacturingHero = pgTable(
	...
	(table) => [
		...
		index("manufacturing_hero_background_media_id_idx").on(
			table.backgroundMediaId,
		),
	],
);
...
export const technologyHero = pgTable(
	...
	(table) => [
		...
		index("technology_hero_background_media_id_idx").on(
			table.backgroundMediaId,
		),
	],
);
...
export const technologyGradientSettings = pgTable(
	...
	(table) => [
		index("technology_gradient_settings_is_active_idx").on(table.isActive),
	],
);
...
export const certificates = pgTable(
	"certificates",
	{
		...
		status: varchar("status", { length: 50 }).default("active"),
		showOnSustainabilityPage: boolean("show_on_sustainability_page").default(
			false,
		), // Missing property causing errors
		isActive: boolean("is_active").default(true),
		createdAt: timestamp("created_at", {
	...
	(table) => [
		...
		index("certificates_show_on_sustainability_idx").on(
			table.showOnSustainabilityPage,
		),
...
export const auditLogs = pgTable("audit_logs", {
	...
	// Enterprise features
	complianceLevel: varchar("compliance_level", { length: 50 }).default(
		"standard",
...
export const auditConfiguration = pgTable("audit_configuration", {
	...
	highComplianceRetentionDays: integer(
		"high_compliance_retention_days",
	).default(3650), // 10 years
	criticalComplianceRetentionDays: integer(
		"critical_compliance_retention_days",
...
export const sustainabilityFeatures = pgTable("sustainability_features", {
	...
	highlightedFeatures: jsonb("highlighted_features").$type<
...
export type InsertUnifiedSustainability =
	typeof unifiedSustainability.$inferInsert;
...
export const insertTechnologyInnovationSchema = createInsertSchema(
...
export const insertTechnologyEquipmentSchema = createInsertSchema(
	technologyEquipment,
	{
...
export const insertTechnologyResearchSchema = createInsertSchema(
	technologyResearch,
	{
...
export const insertTechnologyRoadmapSchema = createInsertSchema(
	technologyRoadmap,
	{
...
export const insertTechnologyGradientSettingsSchema = createInsertSchema(
	...
	{
		gradientType: (schema) =>
			schema.min(1, "Gradient type is required").max(100),
...
export type InsertHomepageProcessCard =
	typeof homepageProcessCards.$inferInsert;

export type HomepageSection = typeof homepageSections.$inferSelect;
export type InsertHomepageSection = typeof homepageSections.$inferInsert;

export type HomepageFeaturedProductsSettings =
	typeof homepageFeaturedProductsSettings.$inferSelect;
...
export type InsertSustainabilityMetric =
	typeof sustainabilityMetrics.$inferInsert;

export type SustainabilityInitiative =
	typeof sustainabilityInitiatives.$inferSelect;
export type InsertSustainabilityInitiative =
	typeof sustainabilityInitiatives.$inferInsert;
...
export type InsertManufacturingProcess =
	typeof manufacturingProcesses.$inferInsert;

export type ManufacturingCapability =
	typeof manufacturingCapabilities.$inferSelect;
export type InsertManufacturingCapability =
	typeof manufacturingCapabilities.$inferInsert;

export type ManufacturingQuality = typeof manufacturingQualities.$inferSelect;
export type InsertManufacturingQuality =
	typeof manufacturingQualities.$inferInsert;
...
export type InsertTechnologyInnovation =
	typeof technologyInnovations.$inferInsert;
...
export type InsertLogoAnimationSettings =
	typeof logoAnimationSettings.$inferInsert;

export type StorageAnalysisResult = typeof storageAnalysisResults.$inferSelect;
export type InsertStorageAnalysisResult =
	typeof storageAnalysisResults.$inferInsert;
...
export type InsertSustainabilityFeatures =
	typeof sustainabilityFeatures.$inferInsert;
...
export type TechnologyGradientSettings =
	typeof technologyGradientSettings.$inferSelect;
export type InsertTechnologyGradientSettings =
	typeof technologyGradientSettings.$inferInsert;
...
>;
export type SustainabilityCallToAction = z.infer<
	typeof insertSustainabilityCallToActionSchema
>;
export type SustainabilitySectionHeaders = z.infer<
	typeof insertSustainabilitySectionHeadersSchema
>;
...
export const fabricCompositionsRelations = relations(
	fabricCompositions,
	({ one }) => ({
