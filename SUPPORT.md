...
```mermaid
flowchart TD
    Start["What do you need help with?"] --> Q1{"Is it a private security bug?"}
    Q1 -->|"Yes"| Sec["🛡️ Go to SECURITY.md (Private Alert)"]
    Q1 -->|"No"| Q2{"Is it a software bug or broken screen?"}
    Q2 -->|"Yes"| Bug["🐛 Open a GitHub Bug Report Issue"]
    Q2 -->|"No"| Q3{"Is it a question or feature suggestion?"}
    Q3 -->|"Yes"| Disc["💬 Ask in GitHub Community Discussions"]
    Q3 -->|"No"| Factory["🏢 Contact Factory Business Team"]
```
