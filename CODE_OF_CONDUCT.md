...
```mermaid
flowchart TD
    Issue["Someone feels hurt or uncomfortable"] --> Report["Send a private note to hateem@runapparel.com"]
    Report --> Review["The Friendly Captains quietly review the situation"]
    Review --> Choice{"What kind of issue is it?"}
    Choice -->|"Accident / Small"| FriendlyChat["Friendly chat & gentle reminder of the rules"]
    Choice -->|"Repeated / Mean"| Timeout["Temporary break from the project"]
    Choice -->|"Serious / Harmful"| RedCard["Permanent ban from the community playground"]
```
