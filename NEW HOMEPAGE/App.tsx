...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Navigation Layer */}
      <nav className="fixed top-0 left-0 w-full p-6 md:p-8 flex justify-between items-center z-50 mix-blend-difference text-white pointer-events-none" aria-label="Main Navigation">
          ...
          <div className="hidden md:flex gap-8 pointer-events-auto items-center">
              <Magnetic>
                  <button className="uppercase text-sm tracking-widest hover:text-[#3300FF] transition-all duration-300 px-2 py-4">Work</button>
              </Magnetic>
              <Magnetic>
                  <button className="uppercase text-sm tracking-widest hover:text-[#3300FF] transition-all duration-300 px-2 py-4">Expertise</button>
              </Magnetic>
              <Magnetic>
                  <button className="uppercase text-sm tracking-widest hover:text-[#3300FF] transition-all duration-300 px-2 py-4">Sustainability</button>
              </Magnetic>
          </div>
