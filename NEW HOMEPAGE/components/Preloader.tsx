...
const Preloader: React.FC<PreloaderProps> = ({ onComplete }) => {
  ...
  return (
    <div ref={containerRef} className="fixed inset-0 z-[9999] bg-[#050505] text-[#FAFAFA] flex flex-col justify-between overflow-hidden cursor-wait">
      {/* Top Bar */}
      ...
      <div className="w-full p-8 md:p-12">
        <div className="flex justify-between items-end mb-4">
             <div ref={textRef} className="font-mono text-xs md:text-sm tracking-wider w-full md:w-auto min-h-[20px]">
                [{loadingText}]
            </div>
        ...
        <div className="w-full h-[2px] bg-white/20 overflow-hidden">
            <div 
                ref={barRef} 
                className="h-full bg-[#3300FF] w-full origin-left scale-x-0"
            />
        </div>
      </div>
