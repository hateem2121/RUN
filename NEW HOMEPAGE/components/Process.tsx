...
const Process: React.FC = () => {
  ...
  return (
    <section className="overflow-hidden bg-[#050505] text-[#FAFAFA]">
      <div ref={triggerRef} className="min-h-screen w-full flex flex-col md:flex-row md:items-center overflow-x-hidden relative">
        ...
        <div className="hidden md:block absolute top-1/2 left-0 w-full h-[300px] -translate-y-1/2 pointer-events-none z-0 opacity-30" aria-hidden="true">
        ...
        {/* Container */}
        <div className="flex flex-col md:flex-row h-auto md:h-full w-full pt-24 md:pt-0 will-change-transform" ref={sectionRef}>
          {PROCESS_STEPS.map((step, index) => (
            <div key={index} className="process-card w-full md:w-screen md:h-full flex-shrink-0 flex items-center justify-center p-4 md:p-12 border-b md:border-b-0 md:border-r border-white/10 relative z-10 min-h-[60vh] md:min-h-0">
