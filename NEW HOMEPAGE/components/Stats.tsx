...
const Stats: React.FC = () => {
	...
	return (
		...
		>
			...
			>
				<div className="flex flex-col justify-center relative z-10 pt-12 md:pt-0">
					...
					<p className="text-sm md:text-xl font-light max-w-md text-gray-300 leading-relaxed">
						Blending century-old artisanal techniques with cutting-edge robotic
						precision. We don't just manufacture; we engineer performance.
					</p>
				</div>
			</div>
			...
			<div
				ref={rightRef}
				className="w-full md:w-1/2 flex flex-col relative z-10 text-[#FAFAFA]"
			>
				{KEY_STATS.map((stat, index) => (
					...
					>
						...
						<h4 className="text-xl md:text-2xl uppercase font-bold mb-2">
							{stat.label}
						</h4>
