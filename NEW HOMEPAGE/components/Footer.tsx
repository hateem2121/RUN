          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-8 mt-12 max-w-lg">
            ...
            <div className="group">
              <div className="flex justify-between items-end mb-2">
                <label
                  htmlFor="email"
                  className={`text-xs uppercase tracking-widest block font-mono group-focus-within:text-[#3300FF] transition-colors ${errors.email ? "text-[#FF0033]" : "text-gray-400"}`}
                >
                  02 // Email Protocol
                </label>
                {errors.email && (
            ...
            <div className="group">
              <div className="flex justify-between items-end mb-2">
                <label
                  htmlFor="specs"
                  className={`text-xs uppercase tracking-widest block font-mono group-focus-within:text-[#3300FF] transition-colors ${errors.specs ? "text-[#FF0033]" : "text-gray-400"}`}
                >
