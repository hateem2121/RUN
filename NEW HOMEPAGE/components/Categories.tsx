...
const Categories: React.FC = () => {
  ...
  return (
    <section id="catalogue" className="relative w-full py-32 bg-white overflow-hidden" aria-label="Product Categories">
      ...
      >
          ...
          {CATEGORIES.map((cat, index) => {
            ...
            return (
                ...
                <h2 className="text-[10vw] md:text-[10vw] font-bold uppercase tracking-tighter text-transparent stroke-text group-hover:text-black transition-colors duration-300">
                    {cat.name} <span className="text-blue-600 inline-block align-top text-[2vw]">●</span>
                </h2>
                </div>
            )
          })}
        ...
        <div className="flex whitespace-nowrap animate-marquee-reverse mt-[-2vw] will-change-transform" aria-hidden="true">
          {[...CATEGORIES, ...CATEGORIES].reverse().map((cat, index) => {
             ...
             return (
                ...
                >
                <h2 className="text-[10vw] md:text-[10vw] font-bold uppercase tracking-tighter text-transparent stroke-text group-hover:text-black transition-colors duration-300">
                    {cat.name} <span className="text-[#CCFF00] inline-block align-top text-[2vw]">●</span>
                </h2>
                </div>
             )
          })}
