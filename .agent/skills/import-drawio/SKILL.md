...
Redraw the draw.io file at `$1` as a diagram in this skill's design system, following [`../diagram-design/references/import-drawio.md`](../diagram-design/references/import-drawio.md) and [`../diagram-design/references/output-spec.md`](../diagram-design/references/output-spec.md). Treat those references as the source of truth — don't reimplement the logic here.
