...
Redraw the Mermaid source at `$1` in this skill's design system, following [`../diagram-design/references/import-mermaid.md`](../diagram-design/references/import-mermaid.md) and [`../diagram-design/references/output-spec.md`](../diagram-design/references/output-spec.md). Treat those references as the source of truth.
