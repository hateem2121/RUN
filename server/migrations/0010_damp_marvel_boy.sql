...
CREATE INDEX IF NOT EXISTS "products_tags_gin_idx" ON "products" USING gin ("tags" jsonb_path_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "products_certificate_ids_gin_idx" ON "products" USING gin ("certificate_ids" jsonb_path_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "products_accessory_ids_gin_idx" ON "products" USING gin ("accessory_ids" jsonb_path_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "products_image_ids_gin_idx" ON "products" USING gin ("image_ids" jsonb_path_ops);--> statement-breakpoint
