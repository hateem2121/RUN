...
export const globalErrorHandler = (
  ...
  if (err instanceof AppError) {
    ...
    // Unhandled exception
    logger.error("Unhandled Exception caught in global handler", { requestId, url: req.url }, err);
    // HARDENING: Start
    const message =
    ...
    logger.error("Unknown error object caught", { requestId }, new Error(String(err)));
