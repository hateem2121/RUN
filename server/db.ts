 ...
 */
export async function wakeupDatabase(): Promise<{ success: boolean; latency: number }> {
  const startTime = performance.now();
...
console.log(
  "[Database] ✅ HTTP-based PostgreSQL connection initialized (no more TCP pool exhaustion)",
);
