...
import { queryPerformanceMonitor } from "../../../lib/db/query-performance";
import { alertManager } from "../../../lib/monitoring/alert-manager";
import { errorAggregator } from "../../../lib/monitoring/error-aggregator";
import { httpMetricsTracker } from "../../../lib/monitoring/http-metrics";
import { appStorageService } from "../../../lib/storage/app-service";

vi.mock("../../../lib/db/query-performance", () => ({
  queryPerformanceMonitor: {
    getPerformanceStats: vi.fn(),
  },
}));

vi.mock("../../../lib/monitoring/error-aggregator", () => ({
  errorAggregator: {
    getMetrics: vi.fn(),
  },
}));

vi.mock("../../../lib/monitoring/http-metrics", () => ({
  httpMetricsTracker: {
    getStats: vi.fn(),
