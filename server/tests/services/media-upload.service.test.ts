...
import { mediaUploadService } from "../../services/media/media-upload.service.js";
import { mediaRepository } from "../../services/repositories/index.js";
import { webhookService } from "../../services/system/webhook.service.js";
import { queueMediaProcessing } from "../../services/tasks/media-queue.service.js";
...
vi.mock("../../services/tasks/media-queue.service.js", () => ({
  queueMediaProcessing: vi.fn().mockResolvedValue(undefined),
}));

vi.mock("../../services/system/webhook.service.js", () => ({
  webhookService: {
    trigger: vi.fn(),
  },
}));
...
vi.mock("../../lib/integrations/gltf-processor.js", () => ({
