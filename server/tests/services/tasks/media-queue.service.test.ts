...
type MediaQueueService = typeof import("../../../services/tasks/media-queue.service.js");
...
describe("media-queue.service", () => {
  ...
  beforeEach(() => {
    ...
    vi.doMock("../../../lib/monitoring/logger.js", () => ({
      logger: mockLogger,
    }));
  ...
  async function loadService(): Promise<MediaQueueService> {
    return await import("../../../services/tasks/media-queue.service.js");
  }
