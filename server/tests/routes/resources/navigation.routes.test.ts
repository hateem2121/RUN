...
import { shouldBypassCache } from "../../../lib/utilities/core-utils";
import navigationRouter from "../../../routes/resources/navigation.routes";
...
vi.mock("../../../services/cms/navigation.service", () => ({
  NavigationService: {
    getItems: vi.fn(),
...
vi.mock("../../../services/system/auth.service", () => ({
  authService: {
    requireAdmin: vi.fn((_req, _res, next) => next()),
  },
}));

vi.mock("../../../lib/utilities/core-utils", () => ({
