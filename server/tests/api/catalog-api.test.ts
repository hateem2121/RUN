...
import { setupErrorHandling } from "../../boot/middleware.js";
...
vi.mock("../../lib/cache/upstash-client.js", () => ({
  upstashClient: null,
  getUpstashClient: vi.fn().mockReturnValue(null),
}));

// Query performance monitor — no-op
vi.mock("../../lib/monitoring/query-performance.js", () => ({
...
import categoryRoutes from "../../routes/core/categories.js";
import productRoutes from "../../routes/core/products.js";
