...
describe("ProductRepository", () => {
  let ProductRepository: typeof import("../../services/repositories/product-repository.js").ProductRepository;
  let repository: InstanceType<
    typeof import("../../services/repositories/product-repository.js").ProductRepository
  >;
  ...
  beforeAll(async () => {
    ...
    vi.mock("../../services/repositories/misc-repository", () => ({
      MiscRepository: class {
        getFibers = vi.fn().mockResolvedValue([]);
      },
    }));
    vi.mock("../../services/repositories/query-performance", () => ({
    ...
    const mod = await import("../../services/repositories/product-repository.js");
