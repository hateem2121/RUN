import { Category, InsertCategory, Fiber, InsertFiber, Fabric, InsertFabric, Certificate, InsertCertificate, SizeChart, InsertSizeChart, Accessory, InsertAccessory, Folder, InsertFolder, MediaAsset, InsertMediaAsset, Product, InsertProduct, NavigationItem, InsertNavigationItem, NavigationGlassmorphismSettings, InsertNavigationGlassmorphismSettings, ContactPageConfiguration, InsertContactPageConfiguration, Inquiry, InsertInquiry, HomepageHero, InsertHomepageHero, HomepageSlogan, InsertHomepageSlogan, HomepageProcessCard, InsertHomepageProcessCard, HomepageSection, InsertHomepageSection, HomepageSustainability, InsertHomepageSustainability, LogoAnimationSettings, InsertLogoAnimationSettings, AboutHero, InsertAboutHero, AboutTimelineEntry, InsertAboutTimelineEntry, AboutMapLocation, InsertAboutMapLocation, AboutSection, InsertAboutSection, AboutStatistic, InsertAboutStatistic, AboutTeamMessage, InsertAboutTeamMessage, SustainabilityHero, InsertSustainabilityHero, SustainabilityMetric, InsertSustainabilityMetric, SustainabilityInitiative, InsertSustainabilityInitiative, SustainabilityGoal, InsertSustainabilityGoal, ManufacturingHero, InsertManufacturingHero, ManufacturingProcess, InsertManufacturingProcess, ManufacturingCapability, InsertManufacturingCapability, ManufacturingQuality, InsertManufacturingQuality, TechnologyHero, InsertTechnologyHero, TechnologyInnovation, InsertTechnologyInnovation, TechnologyEquipment, InsertTechnologyEquipment, TechnologyResearch, InsertTechnologyResearch, TechnologyRoadmap, InsertTechnologyRoadmap, TechnologyGradientSettings, InsertTechnologyGradientSettings, TechnologyCta, InsertTechnologyCta, UnifiedSustainability, InsertUnifiedSustainability, AuditLog, AnimationError, InsertAnimationError, PerformanceMetric, InsertPerformanceMetric, StorageAnalysisResult, InsertStorageAnalysisResult, StorageChangeLog, InsertStorageChangeLog } from "../shared/schema.js";
...
export interface IStorage {
    ...
    getMediaAssets(limit?: number, offset?: number, filters?: {
        type?: string;
        search?: string;
        folderId?: number;
    }): Promise<MediaAsset[]>;
    ...
    updateMediaAsset(id: number, mediaAsset: Partial<InsertMediaAsset>): Promise<MediaAsset | undefined>;
    ...
    getProductsSummary(limit?: number, offset?: number, options?: RepositoryCacheOptions): Promise<{
    ...
    updateNavigationItem(id: number, navigationItem: Partial<InsertNavigationItem>): Promise<NavigationItem | undefined>;
    ...
    updateNavigationGlassmorphismSettings(settings: Partial<InsertNavigationGlassmorphismSettings>): Promise<NavigationGlassmorphismSettings>;
    ...
    updateInquiryStatus(id: number, status: string, adminNotes?: string): Promise<Inquiry | undefined>;
    ...
    updateHomepageSlogan(id: number, slogan: Partial<InsertHomepageSlogan>): Promise<HomepageSlogan | undefined>;
    deleteHomepageSlogan(id: number): Promise<boolean>;
    reorderHomepageSlogans(slogans: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateHomepageProcessCard(id: number, card: Partial<InsertHomepageProcessCard>): Promise<HomepageProcessCard | undefined>;
    deleteHomepageProcessCard(id: number): Promise<boolean>;
    reorderHomepageProcessCards(cards: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateHomepageSection(name: string, section: Partial<InsertHomepageSection>): Promise<HomepageSection>;
    updateHomepageSectionById(id: number, section: Partial<InsertHomepageSection>): Promise<HomepageSection | undefined>;
    getHomepageSustainability(): Promise<HomepageSustainability | undefined>;
    updateHomepageSustainability(sustainability: Partial<InsertHomepageSustainability>): Promise<HomepageSustainability>;
    getLogoAnimationSettings(): Promise<LogoAnimationSettings | undefined>;
    updateLogoAnimationSettings(settings: Partial<InsertLogoAnimationSettings>): Promise<LogoAnimationSettings>;
    ...
    updateAboutTimelineEntry(id: number, entry: Partial<InsertAboutTimelineEntry>): Promise<AboutTimelineEntry | undefined>;
    deleteAboutTimelineEntry(id: number): Promise<boolean>;
    reorderAboutTimelineEntries(entries: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateAboutMapLocation(id: number, location: Partial<InsertAboutMapLocation>): Promise<AboutMapLocation | undefined>;
    ...
    updateAboutSection(id: number, section: Partial<InsertAboutSection>): Promise<AboutSection | undefined>;
    deleteAboutSection(id: number): Promise<boolean>;
    reorderAboutSections(sections: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateAboutStatistic(id: number, statistic: Partial<InsertAboutStatistic>): Promise<AboutStatistic | undefined>;
    deleteAboutStatistic(id: number): Promise<boolean>;
    reorderAboutStatistics(statistics: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateSustainabilityMetric(id: number, metric: Partial<InsertSustainabilityMetric>): Promise<SustainabilityMetric | undefined>;
    deleteSustainabilityMetric(id: number): Promise<boolean>;
    reorderSustainabilityMetrics(metrics: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateSustainabilityInitiative(id: number, initiative: Partial<InsertSustainabilityInitiative>): Promise<SustainabilityInitiative | undefined>;
    deleteSustainabilityInitiative(id: number): Promise<boolean>;
    reorderSustainabilityInitiatives(initiatives: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateSustainabilityGoal(id: number, goal: Partial<InsertSustainabilityGoal>): Promise<SustainabilityGoal | undefined>;
    deleteSustainabilityGoal(id: number): Promise<boolean>;
    reorderSustainabilityGoals(goals: {
        id: number;
        position: number;
    }[]): Promise<void>;
    getUnifiedSustainability(): Promise<UnifiedSustainability | undefined>;
    updateUnifiedSustainability(data: Partial<InsertUnifiedSustainability>): Promise<UnifiedSustainability>;
    ...
    updateManufacturingProcess(id: number, process: Partial<InsertManufacturingProcess>): Promise<ManufacturingProcess | undefined>;
    deleteManufacturingProcess(id: number): Promise<boolean>;
    reorderManufacturingProcesses(processes: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    createManufacturingCapability(capability: InsertManufacturingCapability): Promise<ManufacturingCapability>;
    updateManufacturingCapability(id: number, capability: Partial<InsertManufacturingCapability>): Promise<ManufacturingCapability | undefined>;
    deleteManufacturingCapability(id: number): Promise<boolean>;
    reorderManufacturingCapabilities(capabilities: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateManufacturingQuality(id: number, quality: Partial<InsertManufacturingQuality>): Promise<ManufacturingQuality | undefined>;
    deleteManufacturingQuality(id: number): Promise<boolean>;
    reorderManufacturingQualities(qualities: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateTechnologyInnovation(id: number, innovation: Partial<InsertTechnologyInnovation>): Promise<TechnologyInnovation | undefined>;
    deleteTechnologyInnovation(id: number): Promise<boolean>;
    reorderTechnologyInnovations(innovations: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateTechnologyEquipment(id: number, equipment: Partial<InsertTechnologyEquipment>): Promise<TechnologyEquipment | undefined>;
    deleteTechnologyEquipment(id: number): Promise<boolean>;
    reorderTechnologyEquipment(equipment: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateTechnologyResearch(id: number, research: Partial<InsertTechnologyResearch>): Promise<TechnologyResearch | undefined>;
    deleteTechnologyResearch(id: number): Promise<boolean>;
    reorderTechnologyResearch(research: {
        id: number;
        position: number;
    }[]): Promise<void>;
    ...
    updateTechnologyRoadmap(id: number, roadmap: Partial<InsertTechnologyRoadmap>): Promise<TechnologyRoadmap | undefined>;
    deleteTechnologyRoadmap(id: number): Promise<boolean>;
    reorderTechnologyRoadmap(roadmap: {
        id: number;
        position: number;
    }[]): Promise<void>;
    getTechnologyGradientSettings(): Promise<TechnologyGradientSettings | undefined>;
    updateTechnologyGradientSettings(settings: Partial<InsertTechnologyGradientSettings>): Promise<TechnologyGradientSettings>;
    ...
    updateAnimationError(id: number, error: Partial<InsertAnimationError>): Promise<AnimationError | undefined>;
    ...
    updateHomepageFeaturedProductsSettings(settings: Record<string, unknown>): Promise<Record<string, unknown>>;
    getMediaAssetsByIds(ids: string[]): Promise<MediaAsset[]>;
    updateMediaAssetsFolder(ids: number[], folderId: number | null): Promise<number>;
    updateMediaAssetsTags(updates: Array<{
        id: number;
        tags: string[];
    }>): Promise<number>;
    ...
    update(type: 'mediaAssets', id: number, updates: Partial<MediaAsset>): Promise<MediaAsset | undefined>;
