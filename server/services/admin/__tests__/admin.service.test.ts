...
describe("AdminService", () => {
  ...
  describe("restore methods", () => {
    it("restores category", async () => {
      ...
      const result = await adminService.restoreCategory({} as any, 1);
    ...
    it("restores product", async () => {
      ...
      const result = await adminService.restoreProduct({} as any, 1);
      expect(result).toBe(true);
    ...
    it("restores media asset", async () => {
      ...
      const result = await adminService.restoreMediaAsset({} as any, 1);
      expect(result).toBe(true);
  ...
  describe("updateAuditConfig", () => {
    it("updates configuration and logs audit", async () => {
      ...
      await adminService.updateAuditConfig({} as any, {
        enabled: true,
