...
type BusinessEventType = "order_placed" | "cart_add" | "search_zero_results" | "payment_failure";
...
export function trackBusinessEvent(
  ...
  try {
    ...
    // Never crash the app due to metrics tracking
    console.warn(`[Metrics] Failed to track business event '${event}':`, error);
  }
}
