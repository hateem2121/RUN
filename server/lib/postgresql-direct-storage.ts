...
export class DirectPostgreSQLStorage implements IStorage {
		...
		try {
			...
			if (cacheKeys && cacheKeys.length > 0) {
				await Promise.allSettled(
					cacheKeys.map((key) => unifiedCache.clearPattern(key)),
				).catch((err) =>
	...
	async getMediaAssets(
		...
		return (await this.mediaRepository.getMediaAssets(
			limit,
			offset,
			filters,
		)) as any;
	...
	async getMediaAssetsWithCount(
		...
		return (await this.mediaRepository.getMediaAssetsWithCount(
			limit,
			offset,
			filters,
		)) as any;
	...
	async getProductsSummary(
		...
		return await this.productRepository.getProductsSummary(
			limit,
			offset,
			options,
		);
	...
	async getNavigationGlassmorphismSettings(): Promise<
		NavigationGlassmorphismSettings | undefined
	> {
	...
	async updateNavigationGlassmorphismSettings(
		...
		return await this.miscRepository.updateNavigationGlassmorphismSettings(
			settings,
		);
	}
	...
	async getContactPageConfiguration(): Promise<
		ContactPageConfiguration | undefined
	> {
	...
	async updateInquiryStatus(
		...
		return await this.miscRepository.updateInquiryStatus(
			id,
			status,
			adminNotes,
		);
	...
	async reorderHomepageSlogans(
		...
		await this.withTransaction(
			async (tx) => {
				return await this.pageContentRepository.reorderHomepageSlogans(
					slogans,
					tx,
				);
			},
	...
	async getHomepageProcessCards(
		...
		return await this.pageContentRepository.getHomepageProcessCards(
			includeInactive,
		);
	}
	...
	async reorderHomepageProcessCards(
		...
		await this.withTransaction(
			async (tx) => {
				return await this.pageContentRepository.reorderHomepageProcessCards(
					cards,
					tx,
				);
			},
	...
	async getHomepageSections(
		...
		return await this.pageContentRepository.getHomepageSections(
			includeInactive,
		);
	}
	...
	async updateHomepageSection(
		...
		return await this.pageContentRepository.updateHomepageSection(
			name,
			section,
		);
	}
	...
	async updateHomepageSectionById(
		...
		return await this.pageContentRepository.updateHomepageSectionById(
			id,
			section,
		);
	}
	...
	async updateLogoAnimationSettings(
		...
		return await this.pageContentRepository.updateLogoAnimationSettings(
			settings,
		);
	}
	...
	async reorderAboutTimelineEntries(
		...
		return await this.pageContentRepository.reorderAboutTimelineEntries(
			entries,
		);
	}
	...
	async updateAboutMapLocation(
		...
		return await this.pageContentRepository.updateAboutMapLocation(
			id,
			location,
		);
	}
	...
	async updateSustainabilityMetric(
		...
		return await this.pageContentRepository.updateSustainabilityMetric(
			id,
			metric,
		);
	}
	...
	async reorderSustainabilityMetrics(
		...
		return await this.pageContentRepository.reorderSustainabilityMetrics(
			metrics,
		);
	}
	...
	async createSustainabilityInitiative(
		...
		return await this.pageContentRepository.createSustainabilityInitiative(
			initiative,
		);
	}
	...
	async updateSustainabilityInitiative(
		...
		return await this.pageContentRepository.updateSustainabilityInitiative(
			id,
			initiative,
		);
	}
	...
	async reorderSustainabilityInitiatives(
		...
		return await this.pageContentRepository.reorderSustainabilityInitiatives(
			initiatives,
		);
	}
	...
	async updateManufacturingProcess(
		...
		return await this.pageContentRepository.updateManufacturingProcess(
			id,
			process,
		);
	}
	...
	async reorderManufacturingProcesses(
		...
		return await this.pageContentRepository.reorderManufacturingProcesses(
			processes,
		);
	}
	...
	async createManufacturingCapability(
		...
		return await this.pageContentRepository.createManufacturingCapability(
			capability,
		);
	}
	...
	async updateManufacturingCapability(
		...
		return await this.pageContentRepository.updateManufacturingCapability(
			id,
			capability,
		);
	}
	...
	async reorderManufacturingCapabilities(
		...
		return await this.pageContentRepository.reorderManufacturingCapabilities(
			capabilities,
		);
	}
	...
	async updateManufacturingQuality(
		...
		return await this.pageContentRepository.updateManufacturingQuality(
			id,
			quality,
		);
	}
	...
	async reorderManufacturingQualities(
		...
		return await this.pageContentRepository.reorderManufacturingQualities(
			qualities,
		);
	}
	...
	async createTechnologyInnovation(
		...
		return await this.pageContentRepository.createTechnologyInnovation(
			innovation,
		);
	}
	...
	async updateTechnologyInnovation(
		...
		return await this.pageContentRepository.updateTechnologyInnovation(
			id,
			innovation,
		);
	}
	...
	async reorderTechnologyInnovations(
		...
		return await this.pageContentRepository.reorderTechnologyInnovations(
			innovations,
		);
	}
	...
	async createTechnologyEquipment(
		...
		return await this.pageContentRepository.createTechnologyEquipment(
			equipment,
		);
	}
	...
	async updateTechnologyEquipment(
		...
		return await this.pageContentRepository.updateTechnologyEquipment(
			id,
			equipment,
		);
	}
	...
	async reorderTechnologyEquipment(
		...
		return await this.pageContentRepository.reorderTechnologyEquipment(
			equipment,
		);
	}
	...
	async updateTechnologyResearch(
		...
		return await this.pageContentRepository.updateTechnologyResearch(
			id,
			research,
		);
	}
	...
	async reorderTechnologyResearch(
		...
		await this.withTransaction(
			async (tx) => {
				return await this.pageContentRepository.reorderTechnologyResearch(
					research,
					tx,
				);
			},
	...
	async createTechnologyRoadmap(
		roadmap: InsertTechnologyRoadmap,
	...
	async updateTechnologyRoadmap(
		...
		return await this.pageContentRepository.updateTechnologyRoadmap(
			id,
			roadmap,
		);
	}
	...
	async reorderTechnologyRoadmap(
		roadmap: { id: number; position: number }[],
	): Promise<void> {
		await this.withTransaction(
			async (tx) => {
				return await this.pageContentRepository.reorderTechnologyRoadmap(
					roadmap,
					tx,
				);
			},
	...
	async updateTechnologyGradientSettings(
		...
		return await this.pageContentRepository.updateTechnologyGradientSettings(
			settings,
		);
	}
	...
	async createAnimationError(
		error: InsertAnimationError,
	): Promise<AnimationError> {
		const [created] = await db
			.insert(animationErrors)
			.values(error)
			.returning();
		return created!;
	}
	...
	async getPerformanceMetric(
		id: number,
	): Promise<PerformanceMetric | undefined> {
	...
	async deleteStorageAnalysisResult(id: number): Promise<boolean> {
		const result = await db
			.delete(storageAnalysisResults)
			.where(eq(storageAnalysisResults.id, id));
		return (result.rowCount ?? 0) > 0;
	}
	...
	async getStorageChangeLogs(): Promise<StorageChangeLog[]> {
		return await db
			.select()
			.from(storageChangeLogs)
			.orderBy(desc(storageChangeLogs.createdAt));
	}

	async addStorageChangeLog(
		changeLog: InsertStorageChangeLog,
	): Promise<StorageChangeLog> {
		const [created] = await db
			.insert(storageChangeLogs)
			.values(changeLog)
			.returning();
		return created!;
	}
	...
	async deleteStorageChangeLog(id: number): Promise<boolean> {
		const result = await db
			.delete(storageChangeLogs)
			.where(eq(storageChangeLogs.id, id));
		return (result.rowCount ?? 0) > 0;
	}
	...
	async updateHomepageFeaturedProductsSettings(
		...
		return await this.pageContentRepository.updateHomepageFeaturedProductsSettings(
			settings,
		);
	}
	...
	async updateAssetThumbnail(
		...
		try {
			...
			logger.info(
				`✅ Updated asset ${id} with thumbnail: ${thumbnailFilename}`,
			);
			...
			async (tx) => {
				try {
					...
					if (assetsToDelete.length > 0) {
						await tx
							.delete(mediaAssets)
							.where(inArray(mediaAssets.id, assetsToDelete));
					}
	...
	async cleanupAllCorruptEntries(): Promise<{
		...
		try {
			...
			const productsWithEmptyImages = await db
				...
				.where(
					and(
						...
						or(
							isNull(products.imageIds),
							sql`jsonb_array_length(${products.imageIds}) = 0`,
						),
					),
				);
			...
			const categoriesWithParent = await db
				...
				.from(categories)
				.where(
					and(isNull(categories.deletedAt), isNotNull(categories.parentId)),
				);
			...
			const emptyCategories = await db
				...
				.where(
					and(
						...
						or(eq(categories.name, ""), isNull(categories.name)),
					),
				);
	...
	async updateSustainabilitySectionHeaders(
		headers: unknown[],
	): Promise<unknown[]> {
		// Placeholder implementation for storage interface completeness
		return headers;
