...
import type {
	ProductDetail,
	ProductSummary,
} from "./lib/repositories/product-repository.js";
...
export interface IStorage {
	...
	getNavigationGlassmorphismSettings(): Promise<
	...
	reorderSustainabilityInitiatives(
	...
	reorderManufacturingCapabilities(
	...
	getTechnologyGradientSettings(): Promise<
	...
	getPerformanceMetricsByComponent(
	...
	updateMediaAssetsFolder(
		ids: number[],
		folderId: number | null,
	): Promise<number>;
	updateMediaAssetsTags(
