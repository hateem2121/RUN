...
import {
  ...
  productRepository,
  systemRepository,
} from "../../../../../server/lib/db/repositories/index.js";
import { adminService } from "../../../../../server/services/admin/admin.service";
import type { AuditContext } from "../../../../../server/services/admin/admin.service.js";
...
vi.mock("../../../../../server/lib/resilience/request-timeout", () => ({
...
vi.mock("../../../../../server/lib/integrations/storage-lifecycle-scheduler", () => ({
