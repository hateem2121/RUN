...
vi.mock("../../../../../server/services/semantic-search.service.js", () => ({
  executeSemanticSearch: vi.fn(),
}));

import searchRouter from "../../../../../server/routes/core/search.js";
import { executeSemanticSearch } from "../../../../../server/services/semantic-search.service.js";
